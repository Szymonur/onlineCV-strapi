...
import {
  ...
  TokenName,
  TokenTypeSelect
} from "./chunk-QEQVHMCW.js";
import {
  useCreateAPITokenMutation,
  useGetAPITokenQuery,
  useUpdateAPITokenMutation
} from "./chunk-WS2HEKM6.js";
import {
  API_TOKEN_TYPE
...
// node_modules/@strapi/admin/dist/admin/chunks/EditViewPage-CtZEsOfA.mjs
  ...
  return (0, import_jsx_runtime.jsx)(Grid.Item, {
    ...
    children: selectedAction ? (0, import_jsx_runtime.jsx)(Flex, {
      ...
      children: actionSection && actionSection in routes && routes[actionSection].map((route) => {
        var _a, _b;
        return ((_b = (_a = route.config.auth) == null ? void 0 : _a.scope) == null ? void 0 : _b.includes(selectedAction)) || route.handler === selectedAction ? (0, import_jsx_runtime.jsx)(BoundRoute, {
          route
        }, route.handler) : null;
      })
    }) : (0, import_jsx_runtime.jsxs)(Flex, {
...
var ContentTypesSection = ({ section = null, ...props }) => {
  return (0, import_jsx_runtime.jsx)(Box, {
    children: (0, import_jsx_runtime.jsx)(Accordion.Root, {
      size: "M",
      children: section && section.map((api, index) => (0, import_jsx_runtime.jsx)(CollapsableContentType, {
        label: api.label,
    ...
    children: [
      (0, import_jsx_runtime.jsxs)(Grid.Item, {
        ...
        children: [
          ...
          (data == null ? void 0 : data.permissions) && (0, import_jsx_runtime.jsx)(ContentTypesSection, {
...
var EditView = () => {
  ...
  return (0, import_jsx_runtime.jsx)(ApiTokenPermissionsProvider, {
    value: providerValue,
              ...
              children: [
                ...
                (0, import_jsx_runtime.jsx)(Layouts.Content, {
                  children: (0, import_jsx_runtime.jsxs)(Flex, {
                    ...
                    gap: 6,
                    children: [
                      Boolean(apiToken == null ? void 0 : apiToken.name) && (0, import_jsx_runtime.jsx)(TokenBox, {
                        token: apiToken == null ? void 0 : apiToken.accessKey,
                        tokenType: API_TOKEN_TYPE
                      }),
                      (0, import_jsx_runtime.jsx)(FormApiTokenContainer, {
                        errors,
...
//# sourceMappingURL=chunk-6G4GMGZT.js.map
