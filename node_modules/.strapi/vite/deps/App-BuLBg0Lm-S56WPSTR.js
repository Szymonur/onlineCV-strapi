...
// node_modules/@strapi/plugin-cloud/dist/admin/chunks/App-BuLBg0Lm.mjs
...
var EmptyStateIconWrapper$1 = dt(Box)`
  svg {
    height: 8.8rem;
  }
`;
var CloudBox = () => {
  ...
  return (0, import_jsx_runtime.jsx)(Box, {
    ...
    children: (0, import_jsx_runtime.jsxs)(Flex, {
      ...
      hasRadius: true,
      children: [
        (0, import_jsx_runtime.jsx)(EmptyStateIconWrapper$1, {
          paddingBottom: 6,
          "aria-hidden": true,
          children: (0, import_jsx_runtime.jsx)(UploadIcon, {})
        }),
        ...
        (0, import_jsx_runtime.jsx)(Box, {
          marginTop: 4,
          children: (0, import_jsx_runtime.jsx)(LinkButton, {
            variant: "default",
...
var LinkIcon = () => (0, import_jsx_runtime.jsxs)("svg", {
  width: "160",
  height: "88",
  viewBox: "0 0 160 88",
  fill: "none",
...
var GithubBox = () => {
  ...
  return (0, import_jsx_runtime.jsx)(Box, {
    ...
    children: (0, import_jsx_runtime.jsxs)(Flex, {
      ...
      padding: 11,
      children: [
        (0, import_jsx_runtime.jsx)(EmptyStateIconWrapper, {
          paddingBottom: 6,
          "aria-hidden": true,
        ...
        (0, import_jsx_runtime.jsx)(Box, {
          marginTop: 4,
          children: (0, import_jsx_runtime.jsx)(CustomGithubButton, {
            isExternal: true,
            startIcon: (0, import_jsx_runtime.jsx)(ForwardRef$x, {}),
...
var HomePage = () => {
  ...
  return (0, import_jsx_runtime.jsxs)(Box, {
    ...
    paddingRight: 10,
    children: [
      (0, import_jsx_runtime.jsx)(RightSideCloudContainer, {
      ...
      (0, import_jsx_runtime.jsx)(LeftSideCloudContainer, {
        children: (0, import_jsx_runtime.jsx)("img", {
          alt: "left-side-cloud",
          "aria-hidden": true,
          src: img$1
      ...
      (0, import_jsx_runtime.jsx)(LogoContainer, {
        children: (0, import_jsx_runtime.jsx)("img", {
      ...
      (0, import_jsx_runtime.jsxs)(Box, {
        padding: 10,
        children: [
          (0, import_jsx_runtime.jsxs)(Layouts.Grid, {
            size: "M",
            children: [
              (0, import_jsx_runtime.jsx)(GithubBox, {}),
              (0, import_jsx_runtime.jsx)(CloudBox, {})
            ]
          }),
          (0, import_jsx_runtime.jsxs)(Box, {
            padding: 6,
    ...
    children: (0, import_jsx_runtime.jsxs)(Routes, {
      children: [
        (0, import_jsx_runtime.jsx)(Route, {
          index: true,
          element: (0, import_jsx_runtime.jsx)(HomePage, {})
        }),
        (0, import_jsx_runtime.jsx)(Route, {
          path: "*",
          element: (0, import_jsx_runtime.jsx)(Page.Error, {})
        })
      ]
    })
  });
...
//# sourceMappingURL=App-BuLBg0Lm-S56WPSTR.js.map
