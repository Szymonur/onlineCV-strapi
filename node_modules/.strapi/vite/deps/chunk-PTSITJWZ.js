...
} from "./chunk-6BZHFLRY.js";
import {
  DROP_SENSITIVITY,
  ItemTypes,
  useDragAndDrop
} from "./chunk-SURG3JHW.js";
import {
  getEmptyImage
...
import {
  ...
  getTranslation,
  useDoc
} from "./chunk-5N7HGPKS.js";
import {
  _assertThisInitialized
} from "./chunk-DKMNB4X7.js";
import {
  _inheritsLoose,
...
// node_modules/@strapi/content-manager/dist/admin/chunks/Relations-CiOfFNxW.mjs
var import_jsx_runtime = __toESM(require_jsx_runtime(), 1);
var React = __toESM(require_react(), 1);
var import_pipe = __toESM(require_pipe(), 1);
var [ComponentProvider, useComponent] = createContext("ComponentContext", {
  id: void 0,
  level: -1,
  uid: void 0,
  type: void 0
...
var RELATIONS_TO_DISPLAY = 5;
var ONE_WAY_RELATIONS = [
  "oneWay",
  "oneToOne",
  "manyToOne",
  "oneToManyMorph",
...
var UnstableRelationsField = React.forwardRef(({ disabled, label, ...props }, ref) => {
  var _a, _b, _c;
  const [currentPage, setCurrentPage] = React.useState(1);
  const { document: document2, model: documentModel } = useDoc();
  const documentId = document2 == null ? void 0 : document2.documentId;
  ...
  const { data, isLoading, isFetching } = useGetRelationsQuery({
    ...
    selectFromResult: (result) => {
      ...
      return {
        ...
        data: {
          ...result.data,
          results: ((_a2 = result.data) == null ? void 0 : _a2.results) ? result.data.results : []
        }
      };
    }
  });
  ...
  const relationsConnected = (((_a = field.value) == null ? void 0 : _a.connect) ?? []).filter((rel) => data.results.findIndex((relation) => relation.id === rel.id) === -1).length ?? 0;
  const relationsDisconnected = ((_c = (_b = field.value) == null ? void 0 : _b.disconnect) == null ? void 0 : _c.length) ?? 0;
  ...
  const relations = React.useMemo(() => {
    ...
    const transformations = (0, import_pipe.default)(removeConnected(ctx), removeDisconnected(ctx), addLabelAndHref(ctx));
    const transformedRels = transformations([
      ...data.results
    ]);
    return [
      ...transformedRels,
      ...((_a2 = field.value) == null ? void 0 : _a2.connect) ?? []
    ].sort((a, b) => {
  ...
  const handleConnect = (relation) => {
    ...
    const item = {
      ...
      */
      __temp_key__: generateNKeysBetween((lastItemInList == null ? void 0 : lastItemInList.__temp_key__) ?? null, null, 1)[0],
      // Fallback to `id` if there is no `mainField` value, which will overwrite the above `id` property with the exact same data.
      [((_a2 = props.mainField) == null ? void 0 : _a2.name) ?? "documentId"]: relation[((_b2 = props.mainField) == null ? void 0 : _b2.name) ?? "documentId"],
    ...
    if (ONE_WAY_RELATIONS.includes(props.attribute.relation)) {
      (_d = (_c2 = field.value) == null ? void 0 : _c2.connect) == null ? void 0 : _d.forEach(handleDisconnect);
      ...
      field.onChange(`${props.name}.connect`, [
        ...((_e = field.value) == null ? void 0 : _e.connect) ?? [],
        item
      ]);
    }
  };
  return (0, import_jsx_runtime.jsxs)(Flex, {
    ...
    wrap: "wrap",
    children: [
      (0, import_jsx_runtime.jsxs)(StyledFlex, {
        direction: "column",
        alignItems: "start",
        gap: 2,
        width: "100%",
        children: [
          (0, import_jsx_runtime.jsx)(RelationsInput, {
            disabled: isDisabled,
          ...
          "pagination" in data && data.pagination && data.pagination.pageCount > data.pagination.page ? (0, import_jsx_runtime.jsx)(TextButton, {
      ...
      (0, import_jsx_runtime.jsx)(UnstableRelationsList, {
        data: relations,
...
var RelationsField = React.forwardRef(({ disabled, label, ...props }, ref) => {
  var _a, _b, _c;
  const [currentPage, setCurrentPage] = React.useState(1);
  const { document: document2, model: documentModel } = useDoc();
  const documentId = document2 == null ? void 0 : document2.documentId;
  ...
  return (0, import_jsx_runtime.jsxs)(Flex, {
    ...
    children: [
      ...
      (0, import_jsx_runtime.jsx)(RelationsList, {
        data: relations,
        serverData: data.results,
        disabled: isDisabled,
        name: props.name,
...
var StyledFlex = dt(Flex)`
  & > div {
    width: 100%;
  }
`;
var removeConnected = ({ field }) => (relations) => {
  return relations.filter((relation) => {
    const connectedRelations = (field == null ? void 0 : field.connect) ?? [];
    return connectedRelations.findIndex((rel) => rel.id === relation.id) === -1;
  });
};
var removeDisconnected = ({ field }) => (relations) => relations.filter((relation) => {
  const disconnectedRelations = (field == null ? void 0 : field.disconnect) ?? [];
  return disconnectedRelations.findIndex((rel) => rel.id === relation.id) === -1;
});
var addLabelAndHref = ({ mainField, href }) => (relations) => relations.map((relation) => {
  return {
    ...relation,
    // Fallback to `id` if there is no `mainField` value, which will overwrite the above `documentId` property with the exact same data.
    [(mainField == null ? void 0 : mainField.name) ?? "documentId"]: relation[(mainField == null ? void 0 : mainField.name) ?? "documentId"],
    label: getRelationLabel(relation, mainField),
    href: `${href}/${relation.documentId}?${relation.locale ? `plugins[i18n][locale]=${relation.locale}` : ""}`
  };
});
var RelationsInput = ({ hint, id, model, label, labelAction, name, mainField, placeholder, required, unique: _unique, "aria-label": _ariaLabel, onChange, ...props }) => {
  var _a, _b;
  ...
  React.useEffect(() => {
    ...
    searchForTrigger({
      ...
      params: {
        ...
        id: id ?? "",
        pageSize: 10,
        idsToInclude: ((_b2 = (_a2 = field.value) == null ? void 0 : _a2.disconnect) == null ? void 0 : _b2.map((rel) => rel.id.toString())) ?? [],
        idsToOmit: ((_d = (_c = field.value) == null ? void 0 : _c.connect) == null ? void 0 : _d.map((rel) => rel.id.toString())) ?? [],
        ...searchParamsDebounced
      }
    });
  }, [
    (_a = field.value) == null ? void 0 : _a.connect,
    (_b = field.value) == null ? void 0 : _b.disconnect,
    id,
    model,
    name,
    query,
  ...
  const hasNextPage = (data == null ? void 0 : data.pagination) ? data.pagination.page < data.pagination.pageCount : false;
  const options = (data == null ? void 0 : data.results) ?? [];
          ...
          return (0, import_jsx_runtime.jsx)(Option, {
            ...
            children: (0, import_jsx_runtime.jsxs)(Flex, {
              ...
              children: [
                ...
                opt.status ? (0, import_jsx_runtime.jsx)(DocumentStatus, {
                  status: opt.status
                }) : null
              ]
            })
...
var RELATION_ITEM_HEIGHT = 50;
var RELATION_GUTTER = 4;
var UnstableRelationsList = ({ data, serverData, disabled, name, isLoading, relationType }) => {
  ...
  React.useEffect(() => {
    ...
    const outerListRefCurrent = outerListRef == null ? void 0 : outerListRef.current;
  ...
  const handleMoveItem = (newIndex, oldIndex) => {
    ...
    const startKey = oldIndex > newIndex ? (_a = newData[newIndex - 1]) == null ? void 0 : _a.__temp_key__ : (_b = newData[newIndex]) == null ? void 0 : _b.__temp_key__;
    const endKey = oldIndex > newIndex ? (_c = newData[newIndex]) == null ? void 0 : _c.__temp_key__ : (_d = newData[newIndex + 1]) == null ? void 0 : _d.__temp_key__;
  ...
  return (0, import_jsx_runtime.jsxs)(ShadowBox, {
    ...
    children: [
      ...
      (0, import_jsx_runtime.jsx)(FixedSizeList, {
...
var RelationsList = ({ data, serverData, disabled, name, isLoading, relationType }) => {
  const ariaDescriptionId = React.useId();
  const { formatMessage } = useIntl();
  const listRef = React.useRef(null);
  const outerListRef = React.useRef(null);
...
`;
var CustomTextButton = dt(TextButton)`
  & > span {
    font-size: ${({ theme }) => theme.fontSizes[2]};
  }
`;
var UnstableListItem = ({ data, index, style }) => {
  ...
  return (0, import_jsx_runtime.jsx)(Box, {
    ...
    children: isDragging ? (0, import_jsx_runtime.jsx)(RelationItemPlaceholder, {}) : (0, import_jsx_runtime.jsxs)(Flex, {
      paddingTop: 2,
      paddingBottom: 2,
      ...
      children: [
        (0, import_jsx_runtime.jsxs)(FlexWrapper, {
          gap: 1,
          children: [
            canDrag ? (0, import_jsx_runtime.jsx)(IconButton, {
              tag: "div",
              role: "button",
              tabIndex: 0,
              withTooltip: false,
              ...
              children: [
                (0, import_jsx_runtime.jsx)(Box, {
                  ...
                  children: (0, import_jsx_runtime.jsx)(TooltipImpl, {
                    description: label,
                    children: (0, import_jsx_runtime.jsx)(CustomTextButton, {
                      onClick: () => console.log("OPEN MODAL"),
                      children: label
                    })
                  })
                }),
                status ? (0, import_jsx_runtime.jsx)(DocumentStatus, {
                  status
                }) : null
              ]
            })
            ...
            (0, import_jsx_runtime.jsxs)(Flex, {
              ...
              children: [
                (0, import_jsx_runtime.jsx)(Box, {
                  ...
                  children: (0, import_jsx_runtime.jsx)(TooltipImpl, {
                    description: label,
                    children: href ? (0, import_jsx_runtime.jsx)(LinkEllipsis, {
                      tag: NavLink,
                      to: href,
                      isExternal: false,
                      children: label
...
`;
var DisconnectButton = dt.button`
  svg path {
...
`;
var RelationItemPlaceholder = () => (0, import_jsx_runtime.jsx)(Box, {
  paddingTop: 2,
  paddingBottom: 2,
  paddingLeft: 4,
  paddingRight: 4,
...
var MemoizedRelationsField = React.memo(RelationsField);
var MemoizedUnstableRelationsField = React.memo(UnstableRelationsField);
...
export {
  ...
  MemoizedUnstableRelationsField
};
//# sourceMappingURL=chunk-PTSITJWZ.js.map
