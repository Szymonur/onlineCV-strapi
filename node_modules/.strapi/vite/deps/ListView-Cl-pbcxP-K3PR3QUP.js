...
} from "./chunk-3QWF7NSN.js";
import "./chunk-WJHEGEPQ.js";
import {
  require_sortBy
} from "./chunk-WTXR2LVB.js";
import "./chunk-S42NSOKH.js";
import {
  require_groupBy
} from "./chunk-G2RJXBLX.js";
import "./chunk-HLNGYCF7.js";
import {
  require_slugify
...
// node_modules/@strapi/content-type-builder/dist/admin/chunks/ListView-Cl-pbcxP.mjs
...
var ComponentCard = ({ component, dzName, index, isActive = false, isInDevelopmentMode = false, onClick }) => {
  ...
  const { schema: { icon, displayName } } = (0, import_get.default)(modifiedData, [
    "components",
    component
  ], {
    schema: {}
  ...
  return (0, import_jsx_runtime.jsxs)(ComponentBox, {
    alignItems: "center",
    direction: "column",
    ...
    children: [
      (0, import_jsx_runtime.jsx)(ComponentIcon, {
        icon,
        isActive
      }),
      ...
      isInDevelopmentMode && (0, import_jsx_runtime.jsx)(CloseButton, {
        tag: "button",
        onClick: onClose,
...
var DynamicZoneList = ({ customRowComponent, components = [], addComponent, name, targetUid }) => {
  ...
  return (0, import_jsx_runtime.jsx)(Tr2, {
    ...
    children: (0, import_jsx_runtime.jsxs)("td", {
      colSpan: 12,
      children: [
        (0, import_jsx_runtime.jsx)(FixedBox, {
          paddingLeft: 8,
          children: (0, import_jsx_runtime.jsxs)(ScrollableStack, {
            gap: 2,
            children: [
              isInDevelopmentMode && (0, import_jsx_runtime.jsx)("button", {
                type: "button",
                onClick: handleClickAdd,
                children: (0, import_jsx_runtime.jsxs)(ComponentStack, {
                  direction: "column",
                  alignItems: "stretch",
                  gap: 1,
                  children: [
              ...
              (0, import_jsx_runtime.jsx)(Flex, {
                ...
                children: components.map((component, index) => {
                  return (0, import_jsx_runtime.jsx)(ComponentCard, {
                    dzName: name || "",
                    index,
                    component,
        ...
        (0, import_jsx_runtime.jsx)(ComponentContentBox, {
          children: components.map((component, index) => {
            const props = {
              customRowComponent,
              component
...
var NestedTFooter = ({ children, icon, color, ...props }) => {
  return (0, import_jsx_runtime.jsx)(ButtonBox, {
    paddingBottom: 4,
    paddingTop: 4,
    tag: "button",
    type: "button",
...
var List = ({ addComponentToDZ, customRowComponent, editTarget, firstLoopComponentUid, isFromDynamicZone = false, isMain = false, isNestedInDZComponent = false, isSub = false, items = [], secondLoopComponentUid, targetUid }) => {
  ...
  if (!targetUid) {
    return (0, import_jsx_runtime.jsxs)(Table, {
      colCount: 2,
      rowCount: 2,
      children: [
  ...
  return (0, import_jsx_runtime.jsxs)(BoxWrapper$1, {
    children: [
      (0, import_jsx_runtime.jsx)(Box, {
        paddingLeft: 6,
        ...
        children: (0, import_jsx_runtime.jsxs)("table", {
          children: [
            isMain && (0, import_jsx_runtime.jsx)("thead", {
              children: (0, import_jsx_runtime.jsxs)("tr", {
                children: [
                  (0, import_jsx_runtime.jsx)("th", {
                    children: (0, import_jsx_runtime.jsx)(Typography, {
            ...
            (0, import_jsx_runtime.jsx)("tbody", {
              children: items.map((item) => {
                ...
                return (0, import_jsx_runtime.jsxs)(import_react.Fragment, {
                  children: [
                    (0, import_jsx_runtime.jsx)(CustomRow, {
                      ...item,
                      isNestedInDZComponent,
                      targetUid,
                      editTarget,
                    ...
                    type === "component" && (0, import_jsx_runtime.jsx)(ComponentList, {
                      ...item,
                      customRowComponent,
                      targetUid,
                    ...
                    type === "dynamiczone" && (0, import_jsx_runtime.jsx)(DynamicZoneList, {
                      ...item,
                      customRowComponent,
      ...
      isMain && isInDevelopmentMode && (0, import_jsx_runtime.jsx)(TFooter, {
        cursor: "pointer",
      ...
      isSub && isInDevelopmentMode && !isFromDynamicZone && (0, import_jsx_runtime.jsx)(NestedTFooter, {
        icon: (0, import_jsx_runtime.jsx)(ForwardRef$1h, {}),
        onClick: onClickAddField,
...
var DisplayedType = ({ type, customField = null, repeatable = false }) => {
  ...
  return (0, import_jsx_runtime.jsxs)(Typography, {
    textColor: "neutral800",
    children: [
      formatMessage({
...
var UpperFirst = ({ content }) => (0, import_jsx_runtime.jsx)(import_jsx_runtime.Fragment, {
  children: (0, import_upperFirst.default)(content)
});
var BoxWrapper = dt(Box)`
  position: relative;
`;
var ListRow = (0, import_react.memo)(({ configurable = true, customField = null, editTarget, firstLoopComponentUid = null, isFromDynamicZone = false, name, onClick, relation = "", repeatable = false, secondLoopComponentUid = null, target = null, targetUid = null, type }) => {
  ...
  const contentType = (0, import_get.default)(contentTypes, [
    target
  ], {});
  const contentTypeFriendlyName = (0, import_get.default)(contentType, [
    "schema",
    "displayName"
  ], "");
  ...
  return (0, import_jsx_runtime.jsxs)(BoxWrapper, {
    ...
    children: [
      (0, import_jsx_runtime.jsxs)("td", {
        ...
        children: [
          loopNumber !== 0 && (0, import_jsx_runtime.jsx)(Curve, {
      ...
      (0, import_jsx_runtime.jsx)("td", {
        children: target ? (0, import_jsx_runtime.jsxs)(Typography, {
          textColor: "neutral800",
          children: [
            formatMessage({
            ...
            (0, import_jsx_runtime.jsxs)("span", {
              ...
              children: [
                (0, import_jsx_runtime.jsx)(UpperFirst, {
        ...
        }) : (0, import_jsx_runtime.jsx)(DisplayedType, {
          type,
          customField,
          repeatable
        })
      ...
      (0, import_jsx_runtime.jsx)("td", {
        children: isInDevelopmentMode ? (0, import_jsx_runtime.jsx)(Flex, {
          justifyContent: "flex-end",
          onClick: (e) => e.stopPropagation(),
          children: configurable ? (0, import_jsx_runtime.jsxs)(Flex, {
            gap: 1,
            children: [
              !isMorph && (0, import_jsx_runtime.jsx)(IconButton, {
                onClick: handleClick,
                label: `${formatMessage({
                  id: "app.utils.edit",
                  defaultMessage: "Edit"
          ...
          }) : (0, import_jsx_runtime.jsx)(ForwardRef$2h, {})
        }) : (
          /*
...
var LinkToCMSettingsView = (0, import_react.memo)(({ disabled, isInContentTypeView = true, contentTypeKind = "collectionType", targetUid = "" }) => {
  const { formatMessage } = useIntl();
  ...
  return (0, import_jsx_runtime.jsx)(Button, {
    startIcon: (0, import_jsx_runtime.jsx)(ForwardRef$2n, {}),
    variant: "tertiary",
    onClick: handleClick,
    disabled,
    children: label
...
var ListView = () => {
  ...
  const targetUid = (0, import_get.default)(modifiedData, [
    firstMainDataPath,
    "uid"
  ]);
  ...
  const contentTypeKind = (0, import_get.default)(modifiedData, [
    firstMainDataPath,
    "schema",
    "kind"
  ], null);
  ...
  let label = (0, import_get.default)(modifiedData, [
    firstMainDataPath,
    "schema",
    "displayName"
  ], "");
  const kind = (0, import_get.default)(modifiedData, [
    firstMainDataPath,
    "schema",
    "kind"
  ], "");
  ...
  const primaryAction = isInDevelopmentMode && (0, import_jsx_runtime.jsxs)(Flex, {
    gap: 2,
    marginLeft: 2,
    children: [
      !isCreatingFirstContentType && (0, import_jsx_runtime.jsx)(Button, {
        startIcon: (0, import_jsx_runtime.jsx)(ForwardRef$1h, {}),
        variant: "secondary",
  ...
  const secondaryAction = isInDevelopmentMode && !isFromPlugin && !isCreatingFirstContentType && (0, import_jsx_runtime.jsx)(Button, {
    startIcon: (0, import_jsx_runtime.jsx)(ForwardRef$1v, {}),
    variant: "tertiary",
    onClick: onEdit,
    children: formatMessage({
      id: "app.utils.edit",
  ...
  return (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, {
    children: [
      (0, import_jsx_runtime.jsx)(LayoutsHeaderCustom, {
        id: "title",
        primaryAction,
        secondaryAction,
          ...
          children: [
            (0, import_jsx_runtime.jsx)(Flex, {
              ...
              children: (0, import_jsx_runtime.jsx)(Flex, {
                gap: 2,
                children: (0, import_jsx_runtime.jsx)(LinkToCMSettingsView, {
                  targetUid,
                  isInContentTypeView,
                  contentTypeKind,
            ...
            (0, import_jsx_runtime.jsx)(Box, {
              ...
              children: (0, import_jsx_runtime.jsx)(List, {
                items: attributes,
                customRowComponent: (props) => (0, import_jsx_runtime.jsx)(ListRow, {
                  ...props,
...
//# sourceMappingURL=ListView-Cl-pbcxP-K3PR3QUP.js.map
