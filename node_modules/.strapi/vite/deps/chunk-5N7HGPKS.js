...
// node_modules/@strapi/content-manager/dist/admin/chunks/index-CcJLBLNf.mjs
...
var ProtectedHistoryPage = React.lazy(() => import("./History-DClLuGIg-JJNVPREB.js").then((mod) => ({
...
var ProtectedPreviewPage = React.lazy(() => import("./Preview-05BZGpV2-A5DKMFRB.js").then((mod) => ({
...
var ProtectedEditViewPage = (0, import_react.lazy)(() => import("./EditViewPage-BAI2r49P-5GIXZACN.js").then((mod) => ({
  default: mod.ProtectedEditViewPage
})));
var ProtectedListViewPage = (0, import_react.lazy)(() => import("./ListViewPage-Q0auz5lE-2HKCH7GB.js").then((mod) => ({
  default: mod.ProtectedListViewPage
})));
var ProtectedListConfiguration = (0, import_react.lazy)(() => import("./ListConfigurationPage-Do3UDres-MCOYYIMJ.js").then((mod) => ({
  default: mod.ProtectedListConfiguration
})));
var ProtectedEditConfigurationPage = (0, import_react.lazy)(() => import("./EditConfigurationPage-KDwSFRyn-G5RIHCCM.js").then((mod) => ({
  default: mod.ProtectedEditConfigurationPage
})));
var ProtectedComponentConfigurationPage = (0, import_react.lazy)(() => import("./ComponentConfigurationPage-DKtL-tec-JK3ONPXN.js").then((mod) => ({
  default: mod.ProtectedComponentConfigurationPage
})));
var NoPermissions = (0, import_react.lazy)(() => import("./NoPermissionsPage-BAW7WY-M-NPALHY5Q.js").then((mod) => ({
  default: mod.NoPermissions
})));
var NoContentType = (0, import_react.lazy)(() => import("./NoContentTypePage-B_oOeOQb-MTA6P22Q.js").then((mod) => ({
  ...
  return (0, import_jsx_runtime.jsxs)(Menu.Root, {
    ...
    children: [
      (0, import_jsx_runtime.jsxs)(Menu.Trigger, {
        ...
        variant,
        children: [
          (0, import_jsx_runtime.jsx)(ForwardRef$1V, {
            "aria-hidden": true,
            focusable: false
          }),
...
var PublishAction$1 = ({ activeTab, documentId, model, collectionType, meta, document: document2, onPreview }) => {
  var _a;
  const { schema } = useDoc();
  const navigate = useNavigate();
  const { toggleNotification } = useNotification();
...
var UpdateAction = ({ activeTab, documentId, model, collectionType, onPreview }) => {
  const navigate = useNavigate();
  const { toggleNotification } = useNotification();
  const { _unstableFormatValidationErrors: formatValidationErrors } = useAPIErrorHandler();
  ...
  const { formatMessage } = useIntl();
  const { create: create8, update, clone, isLoading } = useDocumentActions();
  const [{ query, rawQuery }] = useQueryParams();
  const params = React.useMemo(() => buildValidParams(query), [
    query
  ]);
...
var EntryValidationText = ({ validationErrors, status }) => {
  ...
  if (validationErrors) {
    ...
    return (0, import_jsx_runtime.jsxs)(Flex, {
      gap: 2,
      children: [
        (0, import_jsx_runtime.jsx)(ForwardRef$43, {
          fill: "danger600"
        }),
  ...
  if (status === "modified") {
    return (0, import_jsx_runtime.jsxs)(Flex, {
      gap: 2,
      children: [
        (0, import_jsx_runtime.jsx)(ForwardRef$59, {
          fill: "alternative600"
        }),
        (0, import_jsx_runtime.jsx)(Typography, {
          children: formatMessage({
            ...
            children: [
              (0, import_jsx_runtime.jsx)(Td, {
                children: (0, import_jsx_runtime.jsx)(PublicationStatusSummary, {
                  ...
                  icon: (0, import_jsx_runtime.jsx)(ForwardRef$59, {
                    fill: "alternative600"
                  }),
                  message: formatMessage({
                    id: "content-manager.bulk-publish.modified",
              ...
              (0, import_jsx_runtime.jsx)(Td, {
                children: (0, import_jsx_runtime.jsx)(PublicationStatusSummary, {
                  ...
                  icon: (0, import_jsx_runtime.jsx)(ForwardRef$43, {
                    fill: "danger600"
                  }),
                  message: formatMessage({
          ...
          children: [
            (0, import_jsx_runtime.jsx)(Flex, {
              ...
              children: fieldPath.map((pathSegment, index2) => (0, import_jsx_runtime.jsxs)(Typography, {
                ...
                children: [
                  pathSegment,
                  index2 !== fieldPath.length - 1 && (0, import_jsx_runtime.jsx)(ForwardRef$4v, {
                    fill: "neutral500",
                    height: "0.8rem",
                    width: "0.8rem",
                    style: {
...
function __variableDynamicImportRuntime1__(path) {
  switch (path) {
    case "./translations/ar.json":
      return import("./ar-DckYq_WK-OLWWCOSX.js");
    case "./translations/ca.json":
      return import("./ca-DviY7mRj-VJMHET6I.js");
    case "./translations/cs.json":
      return import("./cs-C7OSYFQ7-RR62QNBL.js");
    case "./translations/de.json":
      return import("./de-5QRlDHyR-MNBGDBZP.js");
    case "./translations/en.json":
      return import("./en-CImiNxXE-SYC67T2Z.js");
    case "./translations/es.json":
      return import("./es-DkoWSExG-4LPPXIE7.js");
    case "./translations/eu.json":
      return import("./eu-BG1xX7HK-D4P5Q7MK.js");
    case "./translations/fr.json":
      return import("./fr-CFdRaRVj-SHMLCWY2.js");
    case "./translations/gu.json":
      return import("./gu-D5MMMXRs-6WMHZM5D.js");
    case "./translations/hi.json":
      return import("./hi-lp17SCjr-VMAXJTKH.js");
    case "./translations/hu.json":
      return import("./hu-CLka1U2C-IP5HMW4H.js");
    case "./translations/id.json":
      return import("./id-USfY9m1g-NFOZWYGL.js");
    case "./translations/it.json":
      return import("./it-BAHrwmYS-MDLCNGWP.js");
    case "./translations/ja.json":
      return import("./ja-BWKmBJFT-AWLV7WV6.js");
    case "./translations/ko.json":
      return import("./ko-CgADGBNt-EMUEUFYM.js");
    case "./translations/ml.json":
      return import("./ml-CnhCfOn_-QHISE4Y3.js");
    case "./translations/ms.json":
      return import("./ms-Bh09NFff-WXJADTNL.js");
    case "./translations/nl.json":
      return import("./nl-C8HYflTc-ICCDQEOC.js");
    case "./translations/pl.json":
      return import("./pl-MFCZJZuZ-3OLYVFVU.js");
    case "./translations/pt-BR.json":
      return import("./pt-BR-CcotyBGJ-JPQAW735.js");
    case "./translations/pt.json":
      return import("./pt-HbmgeiYO-5CZQ2ZVV.js");
    case "./translations/ru.json":
      return import("./ru-CB4BUyQp-EZUU47QS.js");
    case "./translations/sa.json":
      return import("./sa-n_aPA-pU-UODJQZLT.js");
    case "./translations/sk.json":
      return import("./sk-tn_BDjE2-LAXUCIAQ.js");
    case "./translations/sv.json":
      return import("./sv-cq4ZrQRd-76362IN7.js");
    case "./translations/th.json":
      return import("./th-mUH7hEtc-WAC77CBQ.js");
    case "./translations/tr.json":
      return import("./tr-Yt38daxh-KXFG54W5.js");
    case "./translations/uk.json":
      return import("./uk-BtM6WnaE-6WNIYZDJ.js");
    case "./translations/vi.json":
      return import("./vi-CvBGlTjr-A3T7BDNP.js");
    case "./translations/zh-Hans.json":
      return import("./zh-Hans-CI0HKio3-FWQ2NNJR.js");
    case "./translations/zh.json":
      return import("./zh-BmF-sHaT-E3RIZWOX.js");
    default:
...
var index = {
  register(app) {
    ...
    app.router.addRoute({
      ...
      lazy: async () => {
        const { Layout } = await import("./layout-4nCaNnTs-CMSG2M6A.js");
        return {
          Component: Layout
        };
      },
...
prismjs/prism.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-5N7HGPKS.js.map
