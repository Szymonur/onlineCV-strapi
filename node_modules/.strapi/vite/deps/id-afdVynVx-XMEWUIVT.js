...
// node_modules/@strapi/review-workflows/dist/admin/chunks/id-afdVynVx.mjs
...
var Stages = ({ canDelete = true, canUpdate = true, isCreating }) => {
  ...
  return (0, import_jsx_runtime.jsxs)(Flex, {
    ...
    children: [
          ...
          (0, import_jsx_runtime.jsx)(Flex, {
            ...
            children: stages.map((stage, index) => {
              return (0, import_jsx_runtime.jsx)(Box, {
                tag: "li",
                children: (0, import_jsx_runtime.jsx)(Stage, {
                  index,
      ...
      canUpdate && (0, import_jsx_runtime.jsx)(AddStage, {
        type: "button",
        onClick: () => {
          addFieldRow("stages", {
            name: ""
...
var Stage = ({ index, canDelete = false, canReorder = false, canUpdate = false, stagesCount, name, permissions, color, defaultOpen }) => {
  ...
  return (0, import_jsx_runtime.jsxs)(Box, {
    ...
    shadow: "tableShadow",
    children: [
      liveText && (0, import_jsx_runtime.jsx)(VisuallyHidden, {
        "aria-live": "assertive",
        children: liveText
      }),
      isDragging ? (0, import_jsx_runtime.jsx)(Box, {
        ...
        hasRadius: true,
        padding: 6
      }) : (0, import_jsx_runtime.jsx)(AccordionRoot, {
        onValueChange: (value) => {
          if (value) {
        ...
        children: (0, import_jsx_runtime.jsxs)(Accordion.Item, {
          value: id,
          children: [
            (0, import_jsx_runtime.jsxs)(Accordion.Header, {
              children: [
                (0, import_jsx_runtime.jsx)(Accordion.Trigger, {
                  children: name
                }),
                (0, import_jsx_runtime.jsx)(Accordion.Actions, {
                  children: canDelete || canUpdate ? (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, {
                    children: [
                      (0, import_jsx_runtime.jsxs)(Menu.Root, {
                        children: [
                          (0, import_jsx_runtime.jsxs)(ContextMenuTrigger, {
                            size: "S",
                            endIcon: null,
                            paddingLeft: 2,
                            paddingRight: 2,
                          ...
                          (0, import_jsx_runtime.jsx)(Menu.Content, {
                            ...
                            zIndex: 2,
                            children: (0, import_jsx_runtime.jsxs)(Menu.SubRoot, {
                              children: [
                                canUpdate && (0, import_jsx_runtime.jsx)(MenuItem, {
                                ...
                                canDelete && (0, import_jsx_runtime.jsx)(DeleteMenuItem, {
            ...
            (0, import_jsx_runtime.jsx)(Accordion.Content, {
              children: (0, import_jsx_runtime.jsx)(Grid.Root, {
                ...
                children: [
                  ...
                  direction: "column",
                  alignItems: "stretch",
                  children: (0, import_jsx_runtime.jsx)(InputRenderer, {
                    ...field
                  })
                }, field.name))
              })
...
var InputRenderer = (props) => {
  switch (props.type) {
    case "color":
      return (0, import_jsx_runtime.jsx)(ColorSelector, {
        ...props
      });
    case "permissions":
      return (0, import_jsx_runtime.jsx)(PermissionsField, {
        ...props
      });
    default:
  ...
  return (0, import_jsx_runtime.jsxs)(Field.Root, {
    ...
    children: [
      ...
      (0, import_jsx_runtime.jsx)(SingleSelect, {
        ...
        startIcon: (0, import_jsx_runtime.jsx)(Flex, {
          tag: "span",
          height: 2,
          background: value,
...
var PermissionsField = ({ disabled, name, placeholder, required }) => {
    ...
    return (0, import_jsx_runtime.jsxs)(Field.Root, {
      ...
      children: [
        ...
        (0, import_jsx_runtime.jsx)(TextInput, {
          ...
          startAction: (0, import_jsx_runtime.jsx)(ForwardRef$3B, {
            fill: "neutral600"
          }),
          type: "text",
          value: ""
  ...
  return (0, import_jsx_runtime.jsx)(import_jsx_runtime.Fragment, {
    children: (0, import_jsx_runtime.jsxs)(Flex, {
      ...
      gap: 3,
      children: [
        (0, import_jsx_runtime.jsx)(PermissionWrapper, {
          grow: 1,
          children: (0, import_jsx_runtime.jsxs)(Field.Root, {
            ...
            children: [
              ...
              (0, import_jsx_runtime.jsx)(MultiSelect, {
                ...
                withTags: true,
                children: (0, import_jsx_runtime.jsx)(MultiSelectGroup, {
                  label: formatMessage({
                  ...
                  children: filteredRoles.map((role) => {
                    return (0, import_jsx_runtime.jsx)(NestedOption$1, {
                      value: `${role.id}`,
                      children: role.name
                    }, role.id);
                  })
  ...
  return (0, import_jsx_runtime.jsxs)(Grid.Root, {
    ...
    children: [
      ...
      (0, import_jsx_runtime.jsx)(Grid.Item, {
        ...
        direction: "column",
        alignItems: "stretch",
        children: (0, import_jsx_runtime.jsx)(ContentTypesSelector, {
          disabled: !canUpdate
        })
      }),
      (0, import_jsx_runtime.jsx)(Grid.Item, {
        ...
        direction: "column",
        alignItems: "stretch",
        children: (0, import_jsx_runtime.jsx)(StageSelector, {
          disabled: !canUpdate
        })
      })
    ]
    ...
    children: [
      ...
      (0, import_jsx_runtime.jsx)(MultiSelect, {
        ...
        children: [
          ...
          return (0, import_jsx_runtime.jsx)(MultiSelectGroup, {
            label: opt.label,
            ...
            children: opt.children.map((child) => {
              ...
              return (0, import_jsx_runtime.jsx)(NestedOption, {
                value: child.value,
                children: (0, import_jsx_runtime.jsx)(Typography, {
                  children: (
                    ...
                    formatMessage({
                      ...
                      em: (...children) => (0, import_jsx_runtime.jsx)(Typography, {
                        tag: "em",
                        fontWeight: "bold",
                        children
                      }),
                      i: (...children) => (0, import_jsx_runtime.jsx)(ContentTypeTakeNotice, {
                        children
                      })
                    })
                  )
          ...
          return (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, {
            children: [
              (0, import_jsx_runtime.jsx)(Header, {
                ...
                primaryAction: canUpdate || canCreate ? (0, import_jsx_runtime.jsx)(Button, {
              ...
              (0, import_jsx_runtime.jsx)(Root, {
                children: (0, import_jsx_runtime.jsxs)(Flex, {
                  alignItems: "stretch",
                  direction: "column",
                  gap: 7,
                  children: [
                    (0, import_jsx_runtime.jsx)(WorkflowAttributes, {
                      canUpdate: canUpdate || canCreate
                    }),
                    (0, import_jsx_runtime.jsx)(Stages, {
                      canDelete,
                      canUpdate: canUpdate || canCreate,
              ...
              (0, import_jsx_runtime.jsx)(Dialog.Root, {
                ...
                children: (0, import_jsx_runtime.jsx)(ConfirmDialog, {
                  ...
                  children: (0, import_jsx_runtime.jsxs)(Flex, {
                    ...
                    gap: 5,
                    children: [
                      savePrompts.hasDeletedServerStages && (0, import_jsx_runtime.jsx)(Typography, {
                        textAlign: "center",
                        variant: "omega",
                        children: formatMessage({
                      ...
                      savePrompts.hasReassignedContentTypes && (0, import_jsx_runtime.jsx)(Typography, {
                        textAlign: "center",
                        variant: "omega",
                        children: formatMessage({
...
//# sourceMappingURL=id-afdVynVx-XMEWUIVT.js.map
