...
import {
  require_map,
  require_tail
} from "./chunk-OXLI56BD.js";
import "./chunk-S42NSOKH.js";
import "./chunk-HLNGYCF7.js";
import "./chunk-MJLW7LIP.js";
import "./chunk-YAXCTSK5.js";
import "./chunk-ZK3YZPFU.js";
import "./chunk-S6Q6FO3U.js";
import "./chunk-R2W6TRN6.js";
import "./chunk-CJNN3ZCK.js";
import "./chunk-VLI27SGI.js";
import "./chunk-DOR7PHOR.js";
import "./chunk-KPHBV4L5.js";
import "./chunk-5N7HGPKS.js";
import "./chunk-6LY4MOO2.js";
import "./chunk-A25ZDIAS.js";
import "./chunk-ORV5KVBM.js";
import "./chunk-XNACAI67.js";
import "./chunk-DKMNB4X7.js";
import "./chunk-NIENZRAG.js";
import {
  require_isEmpty
} from "./chunk-DRDPM3ZR.js";
import "./chunk-O2B3MFGH.js";
import "./chunk-G3VEJZTX.js";
...
// node_modules/@strapi/plugin-users-permissions/dist/admin/chunks/index-BgAfLcWs.mjs
...
var UsersPermissionsProvider = ({ children, value }) => {
  return (0, import_jsx_runtime.jsx)(UsersPermissions$2.Provider, {
    value,
    children
  });
};
...
var SubCategory = ({ subCategory }) => {
  ...
  const handleChangeSelectAll = (0, import_react.useCallback)(({ target: { name } }) => {
    onChangeSelectAll({
      target: {
        name,
  ...
  const isActionSelected = (0, import_react.useCallback)((actionName) => {
        ...
        children: (0, import_jsx_runtime.jsx)(Grid.Root, {
          ...
          children: subCategory.actions.map((action) => {
            ...
            return (0, import_jsx_runtime.jsx)(Grid.Item, {
              ...
              direction: "column",
              alignItems: "stretch",
              children: (0, import_jsx_runtime.jsxs)(CheckboxWrapper, {
...
var PermissionRow = ({ name, permissions }) => {
  ...
  return (0, import_jsx_runtime.jsx)(Box, {
    padding: 6,
    children: subCategories.map((subCategory) => (0, import_jsx_runtime.jsx)(SubCategory, {
      subCategory
    }, subCategory.name))
  });
};
...
var Permissions = () => {
  ...
  return (0, import_jsx_runtime.jsx)(Accordion.Root, {
    size: "M",
    children: (0, import_jsx_runtime.jsx)(Flex, {
      direction: "column",
      alignItems: "stretch",
      gap: 1,
      children: collapses.map((collapse, index) => (0, import_jsx_runtime.jsxs)(Accordion.Item, {
        value: collapse.name,
        children: [
          ...
          (0, import_jsx_runtime.jsx)(Accordion.Content, {
            children: (0, import_jsx_runtime.jsx)(PermissionRow, {
  ...
  return (0, import_jsx_runtime.jsxs)(Flex, {
    ...
    children: [
      ...
      (0, import_jsx_runtime.jsxs)(Flex, {
        ...
        gap: 0,
        children: [
          (0, import_jsx_runtime.jsx)(MethodBox, {
          ...
          (0, import_jsx_runtime.jsx)(Box, {
            paddingLeft: 2,
            paddingRight: 2,
            children: (0, import_map.default)(formattedRoute, (value) => (0, import_jsx_runtime.jsxs)(Typography, {
...
var Policies = () => {
  ...
  return (0, import_jsx_runtime.jsx)(Grid.Item, {
    ...
    direction: "column",
    alignItems: "stretch",
    children: selectedAction ? (0, import_jsx_runtime.jsx)(Flex, {
      direction: "column",
      alignItems: "stretch",
      gap: 2,
      children: displayedRoutes.map((route, key) => (
        // eslint-disable-next-line react/no-array-index-key
        (0, import_jsx_runtime.jsx)(BoundRoute, {
          route
        }, key)
      ))
    }) : (0, import_jsx_runtime.jsxs)(Flex, {
...
var UsersPermissions = (0, import_react.forwardRef)(({ permissions, routes }, ref) => {
  const { formatMessage } = useIntl();
  const [state, dispatch] = (0, import_react.useReducer)(reducer, initialState, (state2) => init(state2, permissions, routes));
  ...
  return (0, import_jsx_runtime.jsx)(UsersPermissionsProvider, {
    value: providerValue,
  ...
  const [{ data: permissions, isLoading: isLoadingPermissions, error: permissionsError, refetch: refetchPermissions }, { data: routes, isLoading: isLoadingRoutes, error: routesError, refetch: refetchRoutes }] = useQueries([
    {
      ...
      async queryFn() {
        const { data: { permissions: permissions2 } } = await get2(`/users-permissions/permissions`);
        return permissions2;
      }
    },
    {
      ...
      async queryFn() {
        const { data: { routes: routes2 } } = await get2(`/users-permissions/routes`);
        return routes2;
      }
    }
  ]);
  ...
  return (0, import_jsx_runtime.jsxs)(Main, {
    children: [
      ...
      (0, import_jsx_runtime.jsx)(Formik, {
        ...
        children: ({ handleSubmit, values, handleChange, errors }) => (0, import_jsx_runtime.jsxs)(Form, {
          noValidate: true,
          onSubmit: handleSubmit,
          children: [
            (0, import_jsx_runtime.jsx)(Layouts.Header, {
              primaryAction: !isLoadingPlugins && (0, import_jsx_runtime.jsx)(Button, {
                type: "submit",
            ...
            (0, import_jsx_runtime.jsx)(Layouts.Content, {
              children: (0, import_jsx_runtime.jsxs)(Flex, {
                ...
                children: [
                  ...
                  !isLoadingPlugins && (0, import_jsx_runtime.jsx)(UsersPermissions$1, {
                    ref: permissionsRef,
                    permissions,
                    routes
                  })
...
var ProtectedRolesCreatePage = () => (0, import_jsx_runtime.jsx)(Page.Protect, {
...
var EditPage = () => {
  ...
  const { data: role, isLoading: isLoadingRole, refetch: refetchRole } = useQuery([
    ...
    const { data: { role: role2 } } = await get2(`/users-permissions/roles/${id}`);
    return role2;
  });
  const permissionsRef = React.useRef();
...
var ProtectedRolesEditPage = () => (0, import_jsx_runtime.jsx)(Page.Protect, {
...
var TableBody = ({ sortedRoles, canDelete, canUpdate, setRoleToDelete, onDelete }) => {
  ...
  return (0, import_jsx_runtime.jsx)(Tbody, {
    children: sortedRoles == null ? void 0 : sortedRoles.map((role) => (0, import_jsx_runtime.jsxs)(Tr, {
      cursor: "pointer",
      ...
      children: [
        ...
        (0, import_jsx_runtime.jsx)(Td, {
          children: (0, import_jsx_runtime.jsxs)(Flex, {
            ...
            children: [
              canUpdate ? (0, import_jsx_runtime.jsx)(EditLink, {
                tag: NavLink,
                to: role.id.toString(),
              ...
              checkCanDeleteRole(role) && (0, import_jsx_runtime.jsx)(IconButton, {
    ...
    children: [
      ...
      (0, import_jsx_runtime.jsxs)(Page.Main, {
        children: [
          ...
          (0, import_jsx_runtime.jsx)(Layouts.Action, {
            startActions: (0, import_jsx_runtime.jsx)(SearchInput, {
              label: formatMessage({
          ...
          (0, import_jsx_runtime.jsxs)(Layouts.Content, {
            children: [
              ...
              canRead && sortedRoles && (sortedRoles == null ? void 0 : sortedRoles.length) ? (0, import_jsx_runtime.jsxs)(Table, {
                colCount,
                rowCount,
                children: [
...
var ProtectedRolesListPage = () => {
  return (0, import_jsx_runtime.jsx)(Page.Protect, {
    ...
    children: (0, import_jsx_runtime.jsx)(RolesListPage, {})
  });
};
var Roles = () => {
  return (0, import_jsx_runtime.jsx)(Page.Protect, {
    ...
    children: (0, import_jsx_runtime.jsxs)(Routes, {
      children: [
        (0, import_jsx_runtime.jsx)(Route, {
          index: true,
          element: (0, import_jsx_runtime.jsx)(ProtectedRolesListPage, {})
        }),
        (0, import_jsx_runtime.jsx)(Route, {
          path: "new",
          element: (0, import_jsx_runtime.jsx)(ProtectedRolesCreatePage, {})
        }),
        (0, import_jsx_runtime.jsx)(Route, {
          path: ":id",
          element: (0, import_jsx_runtime.jsx)(ProtectedRolesEditPage, {})
        })
      ]
    })
  });
...
//# sourceMappingURL=index-BgAfLcWs-KPANGAQL.js.map
