...
// node_modules/@strapi/content-manager/dist/admin/chunks/ListViewPage-Q0auz5lE.mjs
...
var SingleComponent = ({ content, mainField }) => {
  ...
  return (0, import_jsx_runtime.jsx)(TooltipImpl, {
    ...
    children: (0, import_jsx_runtime.jsx)(Typography, {
      ...
      ellipsis: true,
      children: (0, import_jsx_runtime.jsx)(CellValue, {
        type: mainField.type,
  ...
  return (0, import_jsx_runtime.jsxs)(Menu.Root, {
    children: [
      ...
      (0, import_jsx_runtime.jsx)(Menu.Content, {
        children: content.map((item) => (0, import_jsx_runtime.jsx)(Menu.Item, {
          disabled: true,
          children: (0, import_jsx_runtime.jsx)(Typography, {
            maxWidth: "50rem",
            ellipsis: true,
...
var MediaSingle = ({ url, mime, alternativeText, name, ext, formats }) => {
  ...
  if (mime.includes("image")) {
    ...
    return (0, import_jsx_runtime.jsx)(Avatar.Item, {
      src: mediaURL,
  ...
  return (0, import_jsx_runtime.jsx)(TooltipImpl, {
    ...
    children: (0, import_jsx_runtime.jsx)(FileWrapper, {
...
var FileWrapper = ({ children }) => {
  return (0, import_jsx_runtime.jsx)(Flex, {
    ...
    alignItems: "center",
    children: (0, import_jsx_runtime.jsx)(FileTypography, {
      variant: "sigma",
...
var MediaMultiple = ({ content }) => {
  return (0, import_jsx_runtime.jsx)(Avatar.Group, {
    children: content.map((file, index) => {
      const key = `${file.id}${index}`;
      if (index === 3) {
        const remainingFiles = `+${content.length - 3}`;
        return (0, import_jsx_runtime.jsx)(FileWrapper, {
      ...
      return (0, import_jsx_runtime.jsx)(MediaSingle, {
        ...file
      }, key);
    })
  });
...
var RelationMultiple = ({ mainField, content, rowId, name }) => {
  ...
  return (0, import_jsx_runtime.jsxs)(Menu.Root, {
    ...
    children: [
      (0, import_jsx_runtime.jsx)(Menu.Trigger, {
        onClick: (e) => e.stopPropagation(),
        children: (0, import_jsx_runtime.jsx)(Typography, {
          style: {
            cursor: "pointer"
      ...
      (0, import_jsx_runtime.jsxs)(Menu.Content, {
        children: [
          isLoading && (0, import_jsx_runtime.jsx)(Menu.Item, {
            disabled: true,
          ...
          (data == null ? void 0 : data.results) && (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, {
            children: [
              data.results.map((entry) => (0, import_jsx_runtime.jsx)(Menu.Item, {
                disabled: true,
                children: (0, import_jsx_runtime.jsx)(Typography, {
                  maxWidth: "50rem",
                  ellipsis: true,
              ...
              (data == null ? void 0 : data.pagination) && (data == null ? void 0 : data.pagination.total) > 10 && (0, import_jsx_runtime.jsx)(Menu.Item, {
                "aria-disabled": true,
                "aria-label": formatMessage({
...
var CellContent = ({ content, mainField, attribute, rowId, name }) => {
  ...
  switch (attribute.type) {
    case "media":
      ...
      return (0, import_jsx_runtime.jsx)(MediaMultiple, {
        content
      });
    case "relation": {
      if (isSingleRelation(attribute.relation)) {
        return (0, import_jsx_runtime.jsx)(RelationSingle, {
          mainField,
          content
        });
      }
      return (0, import_jsx_runtime.jsx)(RelationMultiple, {
        rowId,
        mainField,
        content,
        name
    ...
    case "component":
      if (attribute.repeatable) {
        return (0, import_jsx_runtime.jsx)(RepeatableComponent, {
          mainField,
          content
        });
      }
      return (0, import_jsx_runtime.jsx)(SingleComponent, {
        mainField,
        content
      });
    case "string":
    ...
    children: [
      ...
      (0, import_jsx_runtime.jsx)(Popover.Content, {
        ...
        children: (0, import_jsx_runtime.jsxs)(Flex, {
          ...
          gap: 3,
          children: [
            canConfigureView ? (0, import_jsx_runtime.jsx)(LinkButton, {
              size: "S",
            ...
            (0, import_jsx_runtime.jsx)(FieldPicker, {
              ...props
            })
          ]
        })
    ...
    children: [
      (0, import_jsx_runtime.jsxs)(Flex, {
        ...
        children: [
          ...
          (0, import_jsx_runtime.jsx)(TextButton, {
            onClick: handleReset,
            children: formatMessage({
    ...
    children: [
      ...
      (0, import_jsx_runtime.jsx)(Layouts.Action, {
        endActions: (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, {
          children: [
            ...
            (0, import_jsx_runtime.jsx)(ViewSettingsMenu, {
        ...
        startActions: (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, {
          children: [
            list.settings.searchable && (0, import_jsx_runtime.jsx)(SearchInput, {
            ...
            list.settings.filterable && schema ? (0, import_jsx_runtime.jsx)(FiltersImpl, {
              disabled: results.length === 0,
              schema
            }) : null
          ]
      ...
      (0, import_jsx_runtime.jsx)(Layouts.Content, {
        children: (0, import_jsx_runtime.jsxs)(Flex, {
          ...
          alignItems: "stretch",
          children: [
            (0, import_jsx_runtime.jsxs)(Table.Root, {
              rows: results,
              headers: tableHeaders,
              isLoading: isFetching,
              children: [
                (0, import_jsx_runtime.jsx)(TableActionsBar, {}),
                (0, import_jsx_runtime.jsxs)(Table.Content, {
                  children: [
                    (0, import_jsx_runtime.jsxs)(Table.Head, {
                      children: [
                        (0, import_jsx_runtime.jsx)(Table.HeaderCheckboxCell, {}),
                        tableHeaders.map((header) => (0, import_jsx_runtime.jsx)(Table.HeaderCell, {
                          ...header
                        }, header.name))
                      ]
                    }),
                    ...
                    (0, import_jsx_runtime.jsx)(Table.Empty, {
                      action: canCreate ? (0, import_jsx_runtime.jsx)(CreateButton, {
                        variant: "secondary"
                      }) : null
                    }),
                      ...
                      children: results.map((row) => {
                        return (0, import_jsx_runtime.jsxs)(Table.Row, {
                          ...
                          children: [
                            ...
                            (0, import_jsx_runtime.jsx)(ActionsCell, {
                              onClick: (e) => e.stopPropagation(),
                              children: (0, import_jsx_runtime.jsx)(TableActions, {
                                document: row
                              })
                            })
                          ]
...
var TableActionsBar = () => {
  ...
  return (0, import_jsx_runtime.jsx)(Table.ActionBar, {
    children: (0, import_jsx_runtime.jsx)(BulkActionsRenderer, {})
  });
};
...
var ProtectedListViewPage = () => {
  ...
  return (0, import_jsx_runtime.jsx)(Page.Protect, {
    ...
    children: ({ permissions: permissions2 }) => (0, import_jsx_runtime.jsx)(DocumentRBAC, {
      ...
      children: (0, import_jsx_runtime.jsx)(ListViewPage, {})
    })
  });
};
export {
...
//# sourceMappingURL=ListViewPage-Q0auz5lE-2HKCH7GB.js.map
