...
// node_modules/@strapi/review-workflows/dist/admin/chunks/index-2VGAYchq.mjs
...
var WorkflowLimitModal = ({ open, onOpenChange }) => {
  const { formatMessage } = useIntl();
  return (0, import_jsx_runtime.jsxs)(LimitsModal.Root, {
    open,
    onOpenChange,
    children: [
...
var Select = ({ stages, activeWorkflowStage, isLoading, ...props }) => {
  ...
  return (0, import_jsx_runtime.jsx)(SingleSelect, {
    ...
    startIcon: activeWorkflowStage && (0, import_jsx_runtime.jsx)(Flex, {
      tag: "span",
      height: 2,
    ...
    customizeContent: () => {
      return (0, import_jsx_runtime.jsxs)(Flex, {
        ...
        children: [
          ...
          isLoading ? (0, import_jsx_runtime.jsx)(Loader, {
            small: true,
            style: {
              display: "flex"
            },
  ...
  if (isCompact) {
    return (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, {
      children: [
        ...
        (0, import_jsx_runtime.jsx)(WorkflowLimitModal, {
          open: showLimitModal === "workflow",
          onOpenChange: () => setShowLimitModal(null)
        }),
        (0, import_jsx_runtime.jsx)(StageLimitModal, {
...
var Header = () => {
  ...
  return (0, import_jsx_runtime.jsxs)(Flex, {
    gap: 2,
    children: [
      (0, import_jsx_runtime.jsx)(AssigneeSelect, {
        isCompact: true
      }),
      (0, import_jsx_runtime.jsx)(StageSelect, {
        isCompact: true
      })
    ]
  });
...
var REVIEW_WORKFLOW_COLUMNS = [
  {
    ...
    cellFormatter: (props) => (0, import_jsx_runtime.jsx)(StageColumn, {
      ...props
    })
  },
  {
    ...
    cellFormatter: (props) => (0, import_jsx_runtime.jsx)(AssigneeColumn, {
      ...props
    })
  }
];
...
function __variableDynamicImportRuntime2__(path) {
  switch (path) {
    case "./translations/en.json":
      return import("./en-BrZXFtVv-3FO4RTWO.js");
    case "./translations/uk.json":
      return import("./uk-DLlzEBUF-SRMG33DN.js");
    default:
  ...
  register(app) {
    ...
    if (window.strapi.features.isEnabled(FEATURE_ID)) {
      ...
      app.addSettingsLink("global", {
        ...
        permissions: [],
        async Component() {
          const { Router } = await import("./router-JyFAzv9_-OHLQMKNR.js");
          return {
            default: Router
          };
        }
      ...
      app.addSettingsLink("global", {
        ...
        permissions: [],
        async Component() {
          const { PurchaseReviewWorkflows } = await import("./purchase-review-workflows-BJkm1_Dd-VN73RUB5.js");
          return {
...
//# sourceMappingURL=chunk-ZK3YZPFU.js.map
