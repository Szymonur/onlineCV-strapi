import {
  useWebhooks
} from "./chunk-XOBYJ72J.js";
import {
  selectAdminPermissions
} from "./chunk-QSTSCDNM.js";
import {
  BackButton,
  Form2 as Form,
  Layouts,
...
// node_modules/@strapi/admin/dist/admin/chunks/EditPage-B9p0M-_e.mjs
    ...
    children: [
      ...
      (0, import_jsx_runtime.jsxs)(Box, {
        ...
        children: [
            ...
            return (0, import_jsx_runtime.jsxs)(Grid.Root, {
              ...
              children: [
                (0, import_jsx_runtime.jsx)(Grid.Item, {
                  ...
                  direction: "column",
                  alignItems: "stretch",
                  children: (0, import_jsx_runtime.jsx)(HeaderCombobox, {
                  ...
                  children: (0, import_jsx_runtime.jsxs)(Flex, {
                    ...
                    children: [
                      (0, import_jsx_runtime.jsx)(Box, {
                        ...
                        children: (0, import_jsx_runtime.jsx)(MemoizedStringInput, {
                      ...
                      (0, import_jsx_runtime.jsx)(IconButton, {
                        ...
                        type: "button",
                        children: (0, import_jsx_runtime.jsx)(ForwardRef$21, {
                          width: "0.8rem"
                        })
                      })
                    ]
          ...
          (0, import_jsx_runtime.jsx)(Box, {
            paddingTop: 4,
            children: (0, import_jsx_runtime.jsx)(AddHeaderButton, {
              type: "button",
              onClick: () => {
                addFieldRow("headers", {
                  key: "",
  ...
  return (0, import_jsx_runtime.jsxs)(Field.Root, {
    ...
    children: [
      ...
      (0, import_jsx_runtime.jsx)(Combobox, {
        ...
        creatable: true,
        value: field.value,
        children: options.map((key) => (0, import_jsx_runtime.jsx)(Option, {
          value: key,
          children: key
        }, key))
      }),
    ...
    children: (0, import_jsx_runtime.jsxs)(Grid.Root, {
      ...
      children: [
        ...
        (0, import_jsx_runtime.jsx)(Grid.Item, {
          ...
          direction: "column",
          alignItems: "stretch",
          children: !isPending ? (0, import_jsx_runtime.jsx)(Message, {
            statusCode,
            message
...
var Status = ({ isPending, statusCode }) => {
  ...
  if (isPending || !statusCode) {
    return (0, import_jsx_runtime.jsxs)(Flex, {
      ...
      alignItems: "center",
      children: [
        (0, import_jsx_runtime.jsx)(ForwardRef$2j, {
          height: "1.2rem",
          width: "1.2rem"
        }),
        (0, import_jsx_runtime.jsx)(Typography, {
...
var WebhookForm = ({ handleSubmit, triggerWebhook, isCreating, isTriggering, triggerResponse, data }) => {
  ...
  const EventTable = useEnterprise(EventTableCE, async () => (await import("./EventsTable-ClYIV-FM-F64RONJD.js")).EventsTableEE);
      ...
      children: [
          ...
          primaryAction: (0, import_jsx_runtime.jsxs)(Flex, {
            ...
            children: [
              (0, import_jsx_runtime.jsx)(Button, {
                ...
                variant: "tertiary",
                startIcon: (0, import_jsx_runtime.jsx)(ForwardRef$1j, {}),
        ...
        (0, import_jsx_runtime.jsx)(Layouts.Content, {
          children: (0, import_jsx_runtime.jsxs)(Flex, {
            ...
            gap: 4,
            children: [
              showTriggerResponse && (0, import_jsx_runtime.jsx)(TriggerContainer, {
...
var EditPage = () => {
  ...
  return (0, import_jsx_runtime.jsxs)(Main, {
    children: [
      ...
      (0, import_jsx_runtime.jsx)(WebhookForm, {
        data: webhook,
        handleSubmit,
...
//# sourceMappingURL=chunk-HKAST3EZ.js.map
