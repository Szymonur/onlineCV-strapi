import {
  CardDragPreview
} from "./chunk-WKAP3UQC.js";
import {
  FieldTypeIcon
} from "./chunk-3K32KWP6.js";
import {
  setIn
} from "./chunk-QXUPE6RX.js";
import {
  ItemTypes,
  useDragAndDrop
...
// node_modules/@strapi/content-manager/dist/admin/chunks/ListConfigurationPage-Do3UDres.mjs
  ...
  return (0, import_jsx_runtime.jsxs)(Flex, {
    ...
    children: [
      ...
      (0, import_jsx_runtime.jsx)(Grid.Root, {
        gap: 4,
        children: formLayout.map((row) => row.map(({ size, ...field }) => (0, import_jsx_runtime.jsx)(Grid.Item, {
          s: 12,
          col: size,
          direction: "column",
          alignItems: "stretch",
      ...
      children: [
        ...
        (0, import_jsx_runtime.jsx)(Modal.Body, {
          children: (0, import_jsx_runtime.jsx)(Grid.Root, {
            ...
            ].filter((field) => field.name !== "sortable" || field.name === "sortable" && shouldDisplaySortToggle).map(({ size, ...field }) => (0, import_jsx_runtime.jsx)(Grid.Item, {
              s: 12,
              col: size,
              direction: "column",
              alignItems: "stretch",
...
var DraggableCard = ({ attribute, index, isDraggingSibling, label, name, onMoveField, onRemoveField, setIsDraggingSibling }) => {
  ...
  return (0, import_jsx_runtime.jsxs)(FieldWrapper, {
    ref: composedRefs,
    children: [
      isDragging && (0, import_jsx_runtime.jsx)(CardDragPreview, {
        label
      }),
      !isDragging && isDraggingSibling && (0, import_jsx_runtime.jsx)(CardDragPreview, {
        isSibling: true,
        label
      }),
      !isDragging && !isDraggingSibling && (0, import_jsx_runtime.jsxs)(FieldContainer, {
            ...
            children: [
              (0, import_jsx_runtime.jsxs)(Modal.Root, {
                ...
                children: [
                  ...
                  (0, import_jsx_runtime.jsx)(EditFieldForm, {
                    attribute,
                    name: `layout.${index}`,
                    onClose: () => {
        ...
        children: [
          (0, import_jsx_runtime.jsx)(Box, {
            ...
            children: (0, import_jsx_runtime.jsx)(Flex, {
              gap: 3,
              children: values.map((field, index) => (0, import_jsx_runtime.jsx)(DraggableCard, {
                index,
                isDraggingSibling,
            ...
            children: [
              (0, import_jsx_runtime.jsxs)(Menu.Trigger, {
                ...
                children: [
                  ...
                  (0, import_jsx_runtime.jsx)(ForwardRef$1h, {
                    "aria-hidden": true,
                    focusable: false,
                    style: {
                      position: "relative",
              ...
              (0, import_jsx_runtime.jsx)(Menu.Content, {
                children: nonDisplayedFields.map((field) => (0, import_jsx_runtime.jsx)(Menu.Item, {
...
var ProtectedListConfiguration = () => {
  ...
  return (0, import_jsx_runtime.jsx)(Page.Protect, {
    permissions,
    children: (0, import_jsx_runtime.jsx)(ListConfiguration, {})
  });
};
export {
  ListConfiguration,
...
//# sourceMappingURL=ListConfigurationPage-Do3UDres-MCOYYIMJ.js.map
