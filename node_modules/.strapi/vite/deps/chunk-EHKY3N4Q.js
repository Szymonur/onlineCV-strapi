...
// node_modules/@strapi/admin/dist/admin/chunks/Permissions-rJmE3qb1.mjs
    ...
    const childrenDefaultForm = childrenForm.reduce((acc2, current) => {
      acc2[current.subCategoryId] = current.actions.reduce((acc3, current2) => {
        ...
        acc3[current2.action] = {
          ...
          conditions: createDefaultConditionsForm$1(conditions, (foundMatchingPermission == null ? void 0 : foundMatchingPermission.conditions) ?? [])
        };
        return acc3;
      }, {});
      return acc2;
...
var createDefaultCTForm = ({ subjects, actions = [] }, conditions, initialPermissions = []) => {
  return actions.reduce((defaultForm, action) => {
    ...
    const contentTypesActions = Object.keys(subjectLayouts).reduce((acc, currentCTUID) => {
      ...
      const conditionsForm = createDefaultConditionsForm$1(conditions, (matchingPermission == null ? void 0 : matchingPermission.conditions) ?? []);
      if (!acc[currentCTUID]) {
        acc[currentCTUID] = {};
      }
...
var RowLabelWithCheckbox = ({ checkboxName = "", children, isActive = false, isCollapsable = false, isFormDisabled = false, label, onChange, onClick, someChecked = false, value }) => {
  ...
  return (0, import_jsx_runtime.jsxs)(Flex, {
    ...
    children: [
      ...
      (0, import_jsx_runtime.jsxs)(CollapseLabel, {
        ...collapseLabelProps,
        children: [
...
var CollapsePropertyMatrix = ({ availableActions = [], childrenForm = [], isFormDisabled, label, pathToData, propertyName }) => {
  ...
  return (0, import_jsx_runtime.jsxs)(Flex, {
    ...
    children: [
      ...
      (0, import_jsx_runtime.jsx)(Box, {
        children: childrenForm.map(({ children: childrenForm2, label: label2, value, required }, i) => (0, import_jsx_runtime.jsx)(ActionRow$1, {
...
var ActionRow$1 = ({ childrenForm = [], label, isFormDisabled = false, name, required = false, pathToData, propertyActions, propertyName, isOdd = false }) => {
  const { formatMessage } = useIntl();
    ...
    children: [
      (0, import_jsx_runtime.jsx)(Wrapper$1, {
        ...
        children: (0, import_jsx_runtime.jsxs)(Flex, {
          children: [
            (0, import_jsx_runtime.jsxs)(RowLabelWithCheckbox, {
              ...
              children: [
                ...
                (0, import_jsx_runtime.jsx)(CarretIcon, {
                  $isActive: isActive
                })
              ]
            }),
      ...
      isActive && (0, import_jsx_runtime.jsx)(SubActionRow, {
  ...
  return (0, import_jsx_runtime.jsxs)(Box, {
    ...
    children: [
      ...
      childrenForm.map(({ label, value, required, children: subChildrenForm }, index) => {
        ...
        return (0, import_jsx_runtime.jsxs)(LeftBorderTimeline, {
          $isVisible: isVisible,
          children: [
            (0, import_jsx_runtime.jsxs)(Flex, {
              height: rowHeight,
              children: [
                (0, import_jsx_runtime.jsx)(StyledBox, {
                ...
                (0, import_jsx_runtime.jsxs)(Flex, {
                  ...
                  children: [
                    (0, import_jsx_runtime.jsx)(RowStyle, {
                      $level: recursiveLevel,
                      $isActive: isActive,
                      $isCollapsable: isArrayType,
                      children: (0, import_jsx_runtime.jsxs)(CollapseLabel, {
                        alignItems: "center",
                        $isCollapsable: isArrayType,
                        ...isArrayType && {
                        ...
                        title: label,
                        children: [
                          (0, import_jsx_runtime.jsx)(RowLabel, {
                            ellipsis: true,
                            children: label
                          }),
                          required && (0, import_jsx_runtime.jsx)(RequiredSign, {}),
            ...
            displayedRecursiveChildren && isActive && (0, import_jsx_runtime.jsx)(Box, {
              paddingBottom: 2,
              children: (0, import_jsx_runtime.jsx)(SubActionRow, {
                isFormDisabled,
...
`;
var ConditionsButtonImpl = React.forwardRef(({ onClick, className, hasConditions = false, variant = "tertiary" }, ref) => {
  const { formatMessage } = useIntl();
  return (0, import_jsx_runtime.jsx)(ButtonContainer, {
...
var ConditionsModal = ({ actions = [], headerBreadCrumbs = [], isFormDisabled, onClose }) => {
  ...
  return (0, import_jsx_runtime.jsxs)(Modal.Content, {
    children: [
      (0, import_jsx_runtime.jsx)(Modal.Header, {
        children: (0, import_jsx_runtime.jsx)(Breadcrumbs, {
          ...
          children: headerBreadCrumbs.map((label, index, arr) => (0, import_jsx_runtime.jsx)(Crumb, {
      ...
      (0, import_jsx_runtime.jsxs)(Modal.Body, {
        children: [
          actionsToDisplay.length === 0 && (0, import_jsx_runtime.jsx)(Typography, {
            children: formatMessage({
          ...
          (0, import_jsx_runtime.jsx)("ul", {
            children: actionsToDisplay.map(({ actionId, label, pathToConditionsObject }, index) => {
              ...
              return (0, import_jsx_runtime.jsx)(ActionRow, {
...
var createDefaultConditionsForm = (actionsToDisplay, modifiedData, arrayOfOptionsGroupedByCategory) => {
  return actionsToDisplay.reduce((acc, current) => {
    const valueFromModifiedData = (0, import_get.default)(modifiedData, [
...
var ActionRow = ({ arrayOfOptionsGroupedByCategory, isFormDisabled = false, isGrey = false, label, name, onChange, value }) => {
  const { formatMessage } = useIntl();
  ...
  return (0, import_jsx_runtime.jsxs)(Flex, {
    ...
    children: [
      ...
      (0, import_jsx_runtime.jsx)(Box, {
        ...
        children: (0, import_jsx_runtime.jsx)(MultiSelectNested, {
          id: name,
  ...
  return (0, import_jsx_runtime.jsx)(import_jsx_runtime.Fragment, {
    children: subjects.map(({ uid, label, properties }, index) => {
      ...
      return (0, import_jsx_runtime.jsxs)(Flex, {
        ...
        children: [
          (0, import_jsx_runtime.jsx)(Collapse, {
            availableActions,
            isActive,
            isGrey: index % 2 === 0,
            isFormDisabled,
          ...
          isActive && properties.map(({ label: propertyLabel, value, children: childrenForm }) => {
            return (0, import_jsx_runtime.jsx)(CollapsePropertyMatrix, {
              availableActions,
              childrenForm,
              isFormDisabled,
              label: propertyLabel,
...
var Collapse = ({ availableActions = [], isActive = false, isGrey = false, isFormDisabled = false, label, onClickToggle, pathToData }) => {
  ...
  return (0, import_jsx_runtime.jsxs)(BoxWrapper, {
    $isActive: isActive,
    children: [
      (0, import_jsx_runtime.jsxs)(Wrapper, {
        height: rowHeight,
        flex: 1,
        alignItems: "center",
        background: isGrey ? "neutral100" : "neutral0",
        children: [
          (0, import_jsx_runtime.jsx)(RowLabelWithCheckbox, {
            isCollapsable: true,
            isFormDisabled,
            label: capitalise(label),
            ...
            value: hasAllActionsSelected,
            isActive,
            children: (0, import_jsx_runtime.jsx)(Chevron, {
              paddingLeft: 2,
              children: isActive ? (0, import_jsx_runtime.jsx)(ForwardRef$4t, {}) : (0, import_jsx_runtime.jsx)(ForwardRef$4z, {})
            })
          }),
          (0, import_jsx_runtime.jsx)(Flex, {
            style: {
            ...
            children: checkboxesActions.map(({ actionId, hasSomeActionsSelected: hasSomeActionsSelected2, isDisplayed, ...restAction }) => {
              ...
              if (isParentCheckbox) {
                return (0, import_jsx_runtime.jsxs)(Cell, {
                  justifyContent: "center",
                  alignItems: "center",
                  children: [
                    hasConditions && (0, import_jsx_runtime.jsx)(Box, {
                      tag: "span",
                      position: "absolute",
                      top: "-6px",
                      left: "37px",
      ...
      (0, import_jsx_runtime.jsx)(Box, {
        ...
        right: "9px",
        position: "absolute",
        children: (0, import_jsx_runtime.jsxs)(Modal.Root, {
          ...
          children: [
            (0, import_jsx_runtime.jsx)(Modal.Trigger, {
              children: (0, import_jsx_runtime.jsx)(ConditionsButton, {
                hasConditions: doesConditionButtonHasConditions
              })
            }),
            (0, import_jsx_runtime.jsx)(ConditionsModal, {
              headerBreadCrumbs: [
                label,
...
var generateCheckboxesActions = (availableActions, modifiedData, pathToData) => {
  return availableActions.map(({ actionId, isDisplayed, applyToProperties, label }) => {
    ...
    const checkboxNameArray = (0, import_isEmpty.default)(applyToProperties) ? [
      ...baseCheckboxNameArray,
      "properties",
      "enabled"
    ] : baseCheckboxNameArray;
    const conditionsValue = (0, import_get.default)(modifiedData, [
      ...baseCheckboxNameArray,
      "conditions"
    ], null);
  ...
  const checkboxesState = React.useMemo(() => {
    ...
    const relatedActionsData = actionsIds.reduce((acc, actionId) => {
      Object.keys(data).forEach((ctUid) => {
        const actionIdData = (0, import_get.default)(data, [
          ctUid,
          actionId
        ]);
        const actionIdState = {
        ...
        return (0, import_jsx_runtime.jsxs)(Flex, {
          ...
          children: [
            ...
            (0, import_jsx_runtime.jsx)(CheckboxImpl, {
              ...
              checked: (0, import_get.default)(checkboxesState, [
                actionId,
                "hasSomeActionsSelected"
              ], false) ? "indeterminate" : (0, import_get.default)(checkboxesState, [
                actionId,
                "hasAllActionsSelected"
              ], false)
            })
...
var ContentTypes = ({ isFormDisabled, kind, layout: { actions, subjects } }) => {
  ...
  return (0, import_jsx_runtime.jsxs)(Box, {
    background: "neutral0",
    children: [
      (0, import_jsx_runtime.jsx)(GlobalActions, {
        actions,
        kind,
        isFormDisabled
      }),
      (0, import_jsx_runtime.jsx)(ContentTypeCollapses, {
        actions,
        isFormDisabled,
        pathToData: kind,
...
var PluginsAndSettingsPermissions = ({ layout, ...restProps }) => {
  return (0, import_jsx_runtime.jsx)(Box, {
    padding: 6,
    background: "neutral0",
    children: (0, import_jsx_runtime.jsx)(Accordion.Root, {
      size: "M",
      children: layout.map(({ category, categoryId, childrenForm }, index) => {
        return (0, import_jsx_runtime.jsx)(Row, {
          childrenForm,
...
var Row = ({ childrenForm, kind, name, isFormDisabled = false, variant, pathToData }) => {
  ...
  return (0, import_jsx_runtime.jsxs)(Accordion.Item, {
    value: name,
    children: [
      (0, import_jsx_runtime.jsx)(Accordion.Header, {
        variant,
        children: (0, import_jsx_runtime.jsx)(Accordion.Trigger, {
          caretPosition: "right",
      ...
      (0, import_jsx_runtime.jsx)(Accordion.Content, {
        children: (0, import_jsx_runtime.jsx)(Box, {
          padding: 6,
          children: childrenForm.map(({ actions, subCategoryName, subCategoryId }) => (0, import_jsx_runtime.jsx)(SubCategory, {
            actions,
            categoryName,
            isFormDisabled,
            subCategoryName,
...
var SubCategory = ({ actions = [], categoryName, isFormDisabled, subCategoryName, pathToData }) => {
  ...
  const formattedActions = React.useMemo(() => {
    return actions.map((action) => {
      ...
      const checkboxValue = (0, import_get.default)(modifiedData, checkboxName, false);
      const conditionValue = (0, import_get.default)(modifiedData, [
        ...pathToData,
        action.action,
        "conditions"
      ], {});
  ...
  const datum = (0, import_get.default)(modifiedData, [
    ...pathToData
  ], {});
            ...
            (0, import_jsx_runtime.jsx)(Grid.Root, {
              ...
              children: formattedActions.map(({ checkboxName, value, action, displayName, hasConditions }) => {
                return (0, import_jsx_runtime.jsx)(Grid.Item, {
                  ...
                  direction: "column",
                  alignItems: "start",
                  children: (0, import_jsx_runtime.jsx)(CheckboxWrapper, {
                    $disabled: isFormDisabled,
                    $hasConditions: hasConditions,
                    children: (0, import_jsx_runtime.jsx)(CheckboxImpl, {
                      name: checkboxName,
...
var Permissions = React.forwardRef(({ layout, isFormDisabled, permissions = [] }, api) => {
      ...
      getPermissions() {
        ...
        if ((0, import_isEmpty.default)(contentTypesDiff)) {
          ...
          didUpdateConditions = Object.values(contentTypesDiff).some((permission = {}) => {
            return Object.values(permission).some((permissionValue) => (0, import_has.default)(permissionValue, "conditions"));
          });
        }
        return {
  ...
  return (0, import_jsx_runtime.jsx)(PermissionsDataManagerProvider, {
    ...
    children: (0, import_jsx_runtime.jsxs)(Tabs.Root, {
      ...
      children: [
        (0, import_jsx_runtime.jsx)(Tabs.List, {
          ...
          children: TAB_LABELS.map((tabLabel) => (0, import_jsx_runtime.jsx)(Tabs.Trigger, {
            value: tabLabel.id,
            children: formatMessage({
              id: tabLabel.labelId,
        ...
        (0, import_jsx_runtime.jsx)(Tabs.Content, {
          ...
          children: (0, import_jsx_runtime.jsx)(ContentTypes, {
        ...
        (0, import_jsx_runtime.jsx)(Tabs.Content, {
          ...
          children: (0, import_jsx_runtime.jsx)(PluginsAndSettingsPermissions, {
  ...
  switch (action.type) {
    case "ON_CHANGE_COLLECTION_TYPE_GLOBAL_ACTION_CHECKBOX": {
      ...
      Object.keys((0, import_get.default)(state, pathToData)).forEach((collectionType) => {
        const collectionTypeActionData = (0, import_get.default)(state, [
          ...pathToData,
          collectionType,
          actionId
        ], void 0);
    ...
    case "ON_CHANGE_COLLECTION_TYPE_ROW_LEFT_CHECKBOX": {
      ...
      Object.keys(objToUpdate).forEach((actionId) => {
        if ((0, import_has.default)(objToUpdate[actionId], `properties.${propertyName}`)) {
          const objValue = (0, import_get.default)(objToUpdate, [
            actionId,
            "properties",
            propertyName,
            rowName
...
//# sourceMappingURL=chunk-EHKY3N4Q.js.map
