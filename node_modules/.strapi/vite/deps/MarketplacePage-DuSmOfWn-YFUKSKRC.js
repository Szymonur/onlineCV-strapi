...
// node_modules/@strapi/admin/dist/admin/chunks/MarketplacePage-DuSmOfWn.mjs
    ...
    children: [
        ...
        children: [
          (0, import_jsx_runtime.jsxs)(Flex, {
            ...
            children: [
              ...
              (0, import_jsx_runtime.jsx)(PackageStats, {
          ...
          (0, import_jsx_runtime.jsx)(Box, {
            ...
            children: (0, import_jsx_runtime.jsx)(Typography, {
              ...
              children: (0, import_jsx_runtime.jsxs)(Flex, {
                ...
                children: [
                  attributes.name,
                  attributes.validated && !attributes.madeByStrapi && (0, import_jsx_runtime.jsx)(TooltipImpl, {
                  ...
                  attributes.madeByStrapi && (0, import_jsx_runtime.jsx)(TooltipImpl, {
          ...
          (0, import_jsx_runtime.jsx)(Box, {
            paddingTop: 2,
            children: (0, import_jsx_runtime.jsx)(EllipsisText, {
              tag: "p",
              variant: "omega",
      ...
      (0, import_jsx_runtime.jsxs)(Flex, {
        ...
        children: [
          ...
          (0, import_jsx_runtime.jsx)(InstallPluginButton, {
            isInstalled,
            isInDevelopmentMode,
            isCompatible,
            commandToCopy,
...
var InstallPluginButton = ({ isInstalled, isInDevelopmentMode, isCompatible, commandToCopy, strapiAppVersion, strapiPeerDepVersion, pluginName }) => {
  ...
  if (isInDevelopmentMode && isCompatible !== false) {
    return (0, import_jsx_runtime.jsx)(CardButton, {
      strapiAppVersion,
...
var PackageStats = ({ githubStars = 0, npmDownloads = 0, npmPackageType }) => {
  ...
  return (0, import_jsx_runtime.jsxs)(Flex, {
    gap: 1,
    children: [
      !!githubStars && (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, {
        children: [
          (0, import_jsx_runtime.jsx)(ForwardRef$x, {
            height: "1.2rem",
            width: "1.2rem",
            "aria-hidden": true
          }),
          (0, import_jsx_runtime.jsx)(ForwardRef$D, {
            height: "1.2rem",
            width: "1.2rem",
            fill: "warning500",
            "aria-hidden": true
...
var NpmPackagesGrid = ({ status, npmPackages = [], installedPackageNames = [], useYarn, isInDevelopmentMode, npmPackageType, strapiAppVersion, debouncedSearch }) => {
  ...
  if (npmPackages.length === 0) {
    return (0, import_jsx_runtime.jsxs)(Box, {
      position: "relative",
      children: [
        (0, import_jsx_runtime.jsx)(Layouts.Grid, {
          size: "M",
          children: Array(12).fill(null).map((_, idx) => (0, import_jsx_runtime.jsx)(EmptyPluginCard, {
            height: "234px",
            hasRadius: true
          }, idx))
        }),
  ...
  return (0, import_jsx_runtime.jsx)(Grid.Root, {
    gap: 4,
    children: npmPackages.map((npmPackage) => (0, import_jsx_runtime.jsx)(Grid.Item, {
      col: 4,
      s: 6,
      xs: 12,
      style: {
      ...
      direction: "column",
      alignItems: "stretch",
      children: (0, import_jsx_runtime.jsx)(NpmPackageCard, {
        npmPackage,
...
var PageHeader = ({ isOnline, npmPackageType = "plugin" }) => {
  ...
  return (0, import_jsx_runtime.jsx)(Layouts.Header, {
    ...
    primaryAction: isOnline && (0, import_jsx_runtime.jsx)(LinkButton, {
...
var SortSelect = ({ sortQuery, handleSelectChange }) => {
  const { formatMessage } = useIntl();
  return (0, import_jsx_runtime.jsx)(SelectWrapper, {
          ...
          children: (0, import_jsx_runtime.jsxs)(Tabs.Root, {
            ...
            children: [
              (0, import_jsx_runtime.jsxs)(Flex, {
                ...
                children: [
                  (0, import_jsx_runtime.jsxs)(Tabs.List, {
                    ...
                    children: [
                      (0, import_jsx_runtime.jsxs)(Tabs.Trigger, {
                        value: PLUGIN,
                        children: [
                          formatMessage({
              ...
              (0, import_jsx_runtime.jsx)(Tabs.Content, {
                value: PLUGIN,
                children: (0, import_jsx_runtime.jsx)(NpmPackagesGrid, {
              ...
              (0, import_jsx_runtime.jsx)(Box, {
                ...
                children: (0, import_jsx_runtime.jsx)("a", {
                  ...
                  children: (0, import_jsx_runtime.jsx)(ContentBox, {
                    title: formatMessage({
                    ...
                    endAction: (0, import_jsx_runtime.jsx)(ForwardRef$3F, {
                      fill: "neutral600",
                      width: "1.2rem",
                      height: "1.2rem",
                      style: {
...
var ProtectedMarketplacePage = () => {
  ...
  return (0, import_jsx_runtime.jsx)(Page.Protect, {
    permissions,
    children: (0, import_jsx_runtime.jsx)(MarketplacePage, {})
  });
};
export {
  MarketplacePage,
...
//# sourceMappingURL=MarketplacePage-DuSmOfWn-YFUKSKRC.js.map
