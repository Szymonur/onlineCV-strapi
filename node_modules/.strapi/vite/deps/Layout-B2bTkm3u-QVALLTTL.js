...
// node_modules/@strapi/admin/dist/admin/chunks/Layout-B2bTkm3u.mjs
...
var useSettingsMenu = () => {
  ...
  const { admin: adminLinks, global: globalLinks } = useEnterprise(ceLinks, async () => (await import("./index-GvH7eseL-VZBYWF5F.js").then(function(n) {
    return n.O;
  })).SETTINGS_LINKS_EE(), {
...
var Layout = () => {
  ...
  return (0, import_jsx_runtime.jsxs)(Layouts.Root, {
    sideNav: (0, import_jsx_runtime.jsx)(SettingsNav, {
      menu
    }),
    children: [
...
//# sourceMappingURL=Layout-B2bTkm3u-QVALLTTL.js.map
