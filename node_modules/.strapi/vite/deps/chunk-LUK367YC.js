...
// node_modules/@strapi/admin/dist/admin/chunks/Theme-C3oHrQcy.mjs
...
var useQueryParams = (initialParams) => {
  ...
  const setQuery = (0, import_react3.useCallback)((nextParams, method = "push", replace = false) => {
    let nextQuery = {
      ...query
    };
    if (method === "remove") {
...
var NotificationsProvider = ({ children }) => {
  ...
  return (0, import_jsx_runtime2.jsxs)(NotificationsContext.Provider, {
    value,
    children: [
      (0, import_jsx_runtime2.jsx)(Flex, {
        ...
        children: notifications.map((notification) => {
          return (0, import_jsx_runtime2.jsx)(Notification, {
            ...notification,
            clearNotification
          }, notification.id);
        })
...
var Notification = ({ clearNotification, blockTransition = false, id, link, message, onClose, timeout = 2500, title, type }) => {
  ...
  return (0, import_jsx_runtime2.jsx)(Alert, {
    action: link ? (0, import_jsx_runtime2.jsx)(Link, {
      href: link.url,
      isExternal: true,
      children: link.label
    }) : void 0,
...
var TrackingProvider = ({ children }) => {
  ...
  return (0, import_jsx_runtime2.jsx)(TrackingContext.Provider, {
    value,
    children
  });
};
...
var ConfigurationProvider = ({ children, defaultAuthLogo, defaultMenuLogo, showReleaseNotification = false }) => {
  ...
  return (0, import_jsx_runtime2.jsx)(ConfigurationContextProvider, {
...
var GuidedTourProvider = ({ children }) => {
  ...
  return (0, import_jsx_runtime2.jsx)(GuidedTourProviderImpl, {
    guidedTourState,
    currentStep,
    setCurrentStep,
...
@strapi/admin/dist/admin/chunks/Theme-C3oHrQcy.mjs:
  (**
  * @preserve
  ...
  *)
*/
//# sourceMappingURL=chunk-LUK367YC.js.map
