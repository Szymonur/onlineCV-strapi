...
// node_modules/@strapi/admin/dist/admin/chunks/ListPage-D7gJ-ZQu.mjs
...
var ModalForm = ({ onToggle }) => {
  ...
  const roleLayout = useEnterprise(ROLE_LAYOUT, async () => (await import("./ModalForm-CZ98aSC9-UY5F63ZI.js")).ROLE_LAYOUT, {
  ...
  const initialValues = useEnterprise(FORM_INITIAL_VALUES, async () => (await import("./ModalForm-CZ98aSC9-UY5F63ZI.js")).FORM_INITIAL_VALUES, {
  ...
  const MagicLink = useEnterprise(MagicLinkCE, async () => (await import("./MagicLinkEE-EYYrim_E-W7F44L6R.js")).MagicLinkEE);
              ...
              children: [
                (0, import_jsx_runtime.jsx)(Modal.Body, {
                  children: (0, import_jsx_runtime.jsxs)(Flex, {
                    ...
                    gap: 6,
                    children: [
                      currentStep !== "create" && (0, import_jsx_runtime.jsx)(MagicLink, {
                        registrationToken
                      }),
                ...
                (0, import_jsx_runtime.jsxs)(Modal.Footer, {
                  children: [
                    ...
                    currentStep === "create" ? (0, import_jsx_runtime.jsx)(Button, {
                      type: "submit",
...
var ListPageCE = () => {
  ...
  const CreateAction = useEnterprise(CreateActionCE, async () => (await import("./CreateActionEE-DZ6ApqOF-NFKLTZVL.js")).CreateActionEE);
  ...
  return (0, import_jsx_runtime.jsxs)(Page.Main, {
    ...
    children: [
      ...
      (0, import_jsx_runtime.jsx)(Layouts.Header, {
        primaryAction: canCreate && (0, import_jsx_runtime.jsx)(CreateAction, {
      ...
      (0, import_jsx_runtime.jsx)(Layouts.Action, {
        startActions: (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, {
          children: [
            ...
            (0, import_jsx_runtime.jsxs)(Filters.Root, {
              options: FILTERS,
              children: [
      ...
      (0, import_jsx_runtime.jsxs)(Layouts.Content, {
        children: [
          (0, import_jsx_runtime.jsxs)(Table.Root, {
            ...
            headers,
            children: [
              (0, import_jsx_runtime.jsx)(Table.ActionBar, {}),
              (0, import_jsx_runtime.jsxs)(Table.Content, {
                children: [
                  (0, import_jsx_runtime.jsxs)(Table.Head, {
                    children: [
                      canDelete ? (0, import_jsx_runtime.jsx)(Table.HeaderCheckboxCell, {}) : null,
                      headers.map((header) => (0, import_jsx_runtime.jsx)(Table.HeaderCell, {
                        ...header
                      }, header.name))
                    ]
                  }),
                  ...
                  (0, import_jsx_runtime.jsx)(Table.Body, {
                    children: users.map((user) => (0, import_jsx_runtime.jsxs)(Table.Row, {
                      onClick: handleRowClick(user.id),
                      cursor: canRead ? "pointer" : "default",
                      children: [
                        canDelete ? (0, import_jsx_runtime.jsx)(Table.CheckboxCell, {
                          id: user.id
                        }) : null,
                        ...
                        canRead || canDelete ? (0, import_jsx_runtime.jsx)(Table.Cell, {
                          onClick: (e) => e.stopPropagation(),
                          children: (0, import_jsx_runtime.jsxs)(Flex, {
                            justifyContent: "end",
                            children: [
                              canRead ? (0, import_jsx_runtime.jsx)(IconButton, {
                                tag: NavLink,
                                to: user.id.toString(),
                                label: formatMessage({
                              ...
                              canDelete ? (0, import_jsx_runtime.jsx)(IconButton, {
      ...
      isModalOpened && (0, import_jsx_runtime.jsx)(ModalForm, {
...
var ListPage = () => {
  const UsersListPage = useEnterprise(ListPageCE, async () => (
    ...
    (await import("./ListPage-CGI2eedJ-IHLPNXK5.js")).UserListPageEE
  ));
  if (!UsersListPage) {
    return null;
  }
  return (0, import_jsx_runtime.jsx)(UsersListPage, {});
};
...
//# sourceMappingURL=chunk-XCQWLNDQ.js.map
