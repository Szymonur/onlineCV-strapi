...
// node_modules/@strapi/content-releases/dist/admin/chunks/App-BEyv0kMo.mjs
...
var RelativeTime$1 = React.forwardRef(({ timestamp, customIntervals = [], ...restProps }, forwardedRef) => {
                ...
                (0, import_jsx_runtime.jsx)(Modal.Body, {
                  children: (0, import_jsx_runtime.jsxs)(Flex, {
                    ...
                    children: [
                      ...
                      values.isScheduled && (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, {
                        children: [
                          (0, import_jsx_runtime.jsxs)(Flex, {
                            gap: 4,
                            alignItems: "start",
                          ...
                          (0, import_jsx_runtime.jsx)(TimezoneComponent, {
...
var ReleasesGrid = ({ sectionTitle, releases = [], isError = false }) => {
  ...
  if ((releases == null ? void 0 : releases.length) === 0) {
    return (0, import_jsx_runtime.jsx)(EmptyStateLayout, {
  ...
  return (0, import_jsx_runtime.jsx)(Grid.Root, {
    gap: 4,
    children: releases.map(({ id, name, scheduledAt, status }) => (0, import_jsx_runtime.jsx)(Grid.Item, {
      col: 3,
      s: 6,
      xs: 12,
      direction: "column",
      alignItems: "stretch",
      children: (0, import_jsx_runtime.jsx)(LinkCard, {
        tag: NavLink,
        to: `${id}`,
        isExternal: false,
        children: (0, import_jsx_runtime.jsxs)(Flex, {
            ...
            (0, import_jsx_runtime.jsxs)(Flex, {
              ...
              children: [
                ...
                (0, import_jsx_runtime.jsx)(Typography, {
                  variant: "pi",
                  textColor: "neutral600",
                  children: scheduledAt ? (0, import_jsx_runtime.jsx)(RelativeTime, {
  ...
  return (0, import_jsx_runtime.jsxs)(Main, {
    ...
    children: [
      (0, import_jsx_runtime.jsx)(Layouts.Header, {
        ...
        primaryAction: canCreate ? (0, import_jsx_runtime.jsx)(Button, {
      ...
      (0, import_jsx_runtime.jsx)(Layouts.Content, {
        children: (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, {
          children: [
            hasReachedMaximumPendingReleases && (0, import_jsx_runtime.jsx)(StyledAlert, {
              marginBottom: 6,
              action: (0, import_jsx_runtime.jsx)(Link2, {
            ...
            (0, import_jsx_runtime.jsxs)(Tabs.Root, {
              ...
              children: [
                ...
                (0, import_jsx_runtime.jsx)(Tabs.Content, {
                  value: "pending",
                  children: (0, import_jsx_runtime.jsx)(ReleasesGrid, {
      ...
      (0, import_jsx_runtime.jsx)(ReleaseModal, {
...
var ReleaseDetailsLayout = ({ toggleEditReleaseModal, toggleWarningSubmit, children }) => {
  ...
  return (0, import_jsx_runtime.jsxs)(Main, {
    ...
    children: [
      (0, import_jsx_runtime.jsx)(Layouts.Header, {
        title: release.name,
        subtitle: (0, import_jsx_runtime.jsxs)(Flex, {
          gap: 2,
          lineHeight: 6,
          children: [
            (0, import_jsx_runtime.jsx)(Typography, {
        ...
        primaryAction: !release.releasedAt && (0, import_jsx_runtime.jsxs)(Flex, {
          gap: 2,
          children: [
            (0, import_jsx_runtime.jsxs)(SimpleMenuButton, {
              label: (0, import_jsx_runtime.jsx)(ForwardRef$1V, {}),
              variant: "tertiary",
              endIcon: null,
              paddingLeft: "7px",
              paddingRight: "7px",
              ...
              children: [
                (0, import_jsx_runtime.jsx)(StyledMenuItem, {
                  disabled: !canUpdate,
                ...
                (0, import_jsx_runtime.jsxs)(ReleaseInfoWrapper, {
                  direction: "column",
                  ...
                  children: [
                    ...
                    (0, import_jsx_runtime.jsxs)(Typography, {
                      ...
                      color: "neutral300",
                      children: [
                        (0, import_jsx_runtime.jsx)(RelativeTime$1, {
            ...
            canPublish ? (0, import_jsx_runtime.jsx)(Button, {
              size: "S",
              variant: "default",
...
var ReleaseDetailsBody = ({ releaseId }) => {
  ...
  if (Object.keys(releaseActions).length === 0) {
    return (0, import_jsx_runtime.jsx)(Layouts.Content, {
    ...
    children: (0, import_jsx_runtime.jsxs)(Flex, {
      ...
      children: [
        (0, import_jsx_runtime.jsx)(Flex, {
          children: (0, import_jsx_runtime.jsx)(SingleSelect, {
        ...
        Object.keys(releaseActions).map((key) => (0, import_jsx_runtime.jsxs)(Flex, {
          gap: 4,
          direction: "column",
          alignItems: "stretch",
          children: [
              ...
              children: (0, import_jsx_runtime.jsxs)(Table.Content, {
                children: [
                  (0, import_jsx_runtime.jsx)(Table.Head, {
                    children: headers.map(({ label, name }) => (0, import_jsx_runtime.jsx)(Table.HeaderCell, {
                  ...
                  (0, import_jsx_runtime.jsx)(Table.Body, {
                    children: releaseActions[key].map(({ id, contentType, locale, type, entry, status }, actionIndex) => (0, import_jsx_runtime.jsxs)(Tr, {
                      children: [
                        ...
                        hasI18nEnabled && (0, import_jsx_runtime.jsx)(Td, {
                          width: "10%",
                          children: (0, import_jsx_runtime.jsx)(Typography, {
                        ...
                        (0, import_jsx_runtime.jsx)(Td, {
                          width: "20%",
                          children: release.releasedAt ? (0, import_jsx_runtime.jsx)(Typography, {
                            children: formatMessage({
                              id: "content-releases.page.ReleaseDetails.table.action-published",
                              defaultMessage: "This entry was <b>{isPublish, select, true {published} other {unpublished}}</b>."
                            }, {
                              isPublish: type === "publish",
                              b: (children) => (0, import_jsx_runtime.jsx)(Typography, {
                                fontWeight: "bold",
                                children
                              })
                            })
                          }) : (0, import_jsx_runtime.jsx)(ReleaseActionOptions, {
                            selected: type,
                        ...
                        !release.releasedAt && (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, {
                          children: [
                            (0, import_jsx_runtime.jsx)(Td, {
                              width: "20%",
                              minWidth: "200px",
                              children: (0, import_jsx_runtime.jsx)(EntryValidationPopover, {
                                action: type,
                            ...
                            (0, import_jsx_runtime.jsx)(Td, {
                              children: (0, import_jsx_runtime.jsx)(Flex, {
                                ...
                                children: (0, import_jsx_runtime.jsxs)(ReleaseActionMenu.Root, {
                                  children: [
                                    (0, import_jsx_runtime.jsx)(ReleaseActionMenu.ReleaseActionEntryLinkItem, {
                                      contentTypeUid: contentType.uid,
                                      documentId: entry.documentId,
                                      locale: locale == null ? void 0 : locale.code
                                    }),
                                    (0, import_jsx_runtime.jsx)(ReleaseActionMenu.DeleteReleaseActionItem, {
...
var ReleaseDetailsPage = () => {
  ...
  if (isLoadingDetails || isLoadingTimezone) {
    return (0, import_jsx_runtime.jsx)(ReleaseDetailsLayout, {
  ...
  return (0, import_jsx_runtime.jsxs)(ReleaseDetailsLayout, {
    toggleEditReleaseModal,
    toggleWarningSubmit,
    children: [
      (0, import_jsx_runtime.jsx)(ReleaseDetailsBody, {
        releaseId
      }),
      (0, import_jsx_runtime.jsx)(ReleaseModal, {
        open: releaseModalShown,
    ...
    children: (0, import_jsx_runtime.jsxs)(Routes, {
      children: [
        (0, import_jsx_runtime.jsx)(Route, {
          index: true,
          element: (0, import_jsx_runtime.jsx)(ReleasesPage, {})
        }),
        (0, import_jsx_runtime.jsx)(Route, {
          path: ":releaseId",
          element: (0, import_jsx_runtime.jsx)(ReleaseDetailsPage, {})
        })
      ]
    })
  });
...
//# sourceMappingURL=App-BEyv0kMo-IEAZUAWO.js.map
