...
// node_modules/@strapi/upload/dist/admin/chunks/App-Dyo0gLZ1.mjs
var import_jsx_runtime = __toESM(require_jsx_runtime(), 1);
var React = __toESM(require_react(), 1);
var import_qs = __toESM(require_lib(), 1);
var import_isEmpty = __toESM(require_isEmpty(), 1);
var import_isEqual = __toESM(require_isEqual(), 1);
import "/Users/szymon/Documents/online-cv/onlineCV-strapi/node_modules/cropperjs/dist/cropper.css";
...
var BulkMoveDialog = ({ onClose, selected = [], currentFolder }) => {
  ...
  return (0, import_jsx_runtime.jsx)(Modal.Content, {
    children: (0, import_jsx_runtime.jsx)(Formik, {
      ...
      children: ({ values, errors, setFieldValue }) => (0, import_jsx_runtime.jsxs)(Form, {
        noValidate: true,
        children: [
              ...
              children: (0, import_jsx_runtime.jsx)(Grid.Item, {
                ...
                children: (0, import_jsx_runtime.jsxs)(Field.Root, {
                  ...
                  children: [
                    ...
                    (0, import_jsx_runtime.jsx)(SelectTree, {
                    ...
                    errors.destination && (0, import_jsx_runtime.jsx)(Typography, {
                      variant: "pi",
                      tag: "p",
                      textColor: "danger600",
    ...
    children: [
      (0, import_jsx_runtime.jsx)(Modal.Trigger, {
        children: (0, import_jsx_runtime.jsx)(Button, {
          variant: "secondary",
          size: "S",
          startIcon: (0, import_jsx_runtime.jsx)(ForwardRef$3h, {}),
          children: formatMessage({
            id: "global.move",
            defaultMessage: "Move"
          })
      ...
      (0, import_jsx_runtime.jsx)(BulkMoveDialog, {
        currentFolder,
...
var BulkActions = ({ selected = [], onSuccess, currentFolder }) => {
  ...
  return (0, import_jsx_runtime.jsxs)(Flex, {
    ...
    children: [
      ...
      (0, import_jsx_runtime.jsx)(BulkDeleteButton, {
        selected,
        onSuccess
      }),
      (0, import_jsx_runtime.jsx)(BulkMoveButton, {
        currentFolder,
        selected,
        onSuccess
      })
...
var EmptyOrNoPermissions = ({ canCreate, isFiltering, canRead, onActionClick }) => {
  ...
  return (0, import_jsx_runtime.jsx)(EmptyAssets, {
    icon: !canRead ? ForwardRef$H : void 0,
    action: canCreate && !isFiltering && (0, import_jsx_runtime.jsx)(Button, {
      variant: "secondary",
...
var Filters = () => {
  ...
  return (0, import_jsx_runtime.jsxs)(Popover.Root, {
    ...
    children: [
      ...
      (0, import_jsx_runtime.jsx)(FilterList, {
...
var Header = ({ breadcrumbs = null, canCreate, folder = null, onToggleEditFolderDialog, onToggleUploadAssetDialog }) => {
  ...
  return (0, import_jsx_runtime.jsx)(Layouts.Header, {
    ...
    subtitle: breadcrumbs && typeof breadcrumbs !== "boolean" && folder && (0, import_jsx_runtime.jsx)(Breadcrumbs, {
      label: formatMessage({
    ...
    navigationAction: folder && (0, import_jsx_runtime.jsx)(Link2, {
      tag: NavLink,
      startIcon: (0, import_jsx_runtime.jsx)(ForwardRef$5j, {}),
      to: `${pathname}?${(0, import_qs.stringify)(backQuery, {
        encode: false
      })}`,
      children: formatMessage({
    ...
    primaryAction: canCreate && (0, import_jsx_runtime.jsxs)(Flex, {
      gap: 2,
      children: [
        (0, import_jsx_runtime.jsx)(Button, {
          startIcon: (0, import_jsx_runtime.jsx)(ForwardRef$1h, {}),
...
var MediaLibrary = () => {
  ...
  return (0, import_jsx_runtime.jsxs)(Layouts.Root, {
    children: [
        ...
        children: [
          ...
          (0, import_jsx_runtime.jsx)(Layouts.Action, {
            startActions: (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, {
              children: [
                canUpdate && isGridView && (assetCount > 0 || folderCount > 0) && (0, import_jsx_runtime.jsx)(BoxWithHeight, {
                  paddingLeft: 2,
                  paddingRight: 2,
                  background: "neutral0",
                  hasRadius: true,
                ...
                canRead && isGridView && (0, import_jsx_runtime.jsx)(SortPicker, {
            ...
            endActions: (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, {
              children: [
                canConfigureView ? (0, import_jsx_runtime.jsx)(ActionContainer, {
                  paddingTop: 1,
                  paddingBottom: 1,
                ...
                (0, import_jsx_runtime.jsx)(ActionContainer, {
                  paddingTop: 1,
                  paddingBottom: 1,
                  children: (0, import_jsx_runtime.jsx)(IconButton, {
                    ...
                    children: isGridView ? (0, import_jsx_runtime.jsx)(ForwardRef$2p, {}) : (0, import_jsx_runtime.jsx)(ForwardRef$39, {})
                  })
                }),
          ...
          (0, import_jsx_runtime.jsxs)(Layouts.Content, {
            children: [
              selected.length > 0 && (0, import_jsx_runtime.jsx)(BulkActions, {
                currentFolder,
                selected,
                onSuccess: handleBulkActionSuccess
              }),
              folderCount === 0 && assetCount === 0 && (0, import_jsx_runtime.jsx)(EmptyOrNoPermissions, {
                canCreate,
                canRead,
                isFiltering,
                onActionClick: toggleUploadAssetDialog
              }),
              canRead && !isGridView && (assetCount > 0 || folderCount > 0) && (0, import_jsx_runtime.jsx)(TableList, {
                assetCount,
                folderCount,
              ...
              canRead && isGridView && (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, {
                children: [
                  folderCount > 0 && (0, import_jsx_runtime.jsx)(FolderGridList, {
                    ...
                    children: folders.map((folder) => {
                      ...
                      return (0, import_jsx_runtime.jsx)(Grid.Item, {
                        ...
                        direction: "column",
                        alignItems: "stretch",
                        children: (0, import_jsx_runtime.jsx)(FolderCard, {
                          ref: folderToEdit && folder.id === folderToEdit.id ? currentFolderToEditRef : void 0,
                          ariaLabel: folder.name,
                          id: `folder-${folder.id}`,
                          to: url,
                          startAction: folder.isSelectable ? (0, import_jsx_runtime.jsx)(FolderCardCheckbox, {
                            "data-testid": `folder-checkbox-${folder.id}`,
                            checked: isSelected,
                            onCheckedChange: () => selectOne(folder)
                          }) : null,
                          cardActions: (0, import_jsx_runtime.jsx)(IconButton, {
                            label: formatMessage({
                          ...
                          children: (0, import_jsx_runtime.jsx)(FolderCardBody, {
                            children: (0, import_jsx_runtime.jsx)(FolderCardBodyAction, {
                              to: url,
                              children: (0, import_jsx_runtime.jsxs)(Flex, {
                                ...
                                maxWidth: "100%",
                                children: [
                                  (0, import_jsx_runtime.jsxs)(TypographyMaxWidth, {
                                    fontWeight: "semiBold",
                                  ...
                                  (0, import_jsx_runtime.jsx)(TypographyMaxWidth, {
                                    tag: "span",
                                    textColor: "neutral600",
                                    variant: "pi",
                                    ellipsis: true,
                  ...
                  assetCount > 0 && folderCount > 0 && (0, import_jsx_runtime.jsx)(Box, {
                    paddingTop: 6,
                    paddingBottom: 4,
                    children: (0, import_jsx_runtime.jsx)(Divider, {})
                  }),
                  assetCount > 0 && (0, import_jsx_runtime.jsx)(AssetGridList, {
                    assets,
                    onEditAsset: setAssetToEdit,
              ...
              (0, import_jsx_runtime.jsxs)(Pagination.Root, {
      ...
      showUploadAssetDialog && (0, import_jsx_runtime.jsx)(UploadAssetDialog, {
        open: showUploadAssetDialog,
        onClose: toggleUploadAssetDialog,
        trackedLocation: "upload",
        folderId: query == null ? void 0 : query.folder
      }),
      showEditFolderDialog && (0, import_jsx_runtime.jsx)(EditFolderDialog, {
      ...
      assetToEdit && (0, import_jsx_runtime.jsx)(EditAssetDialog, {
        onClose: (editedAsset) => {
          if (editedAsset === null) {
...
var ConfigureTheView = React.lazy(async () => import("./ConfigureTheView-CfmaErAH-UVQMUW3G.js").then((mod) => ({
...
var Upload = () => {
  ...
  return (0, import_jsx_runtime.jsxs)(Page.Main, {
    children: [
      ...
      rawQuery ? (0, import_jsx_runtime.jsx)(React.Suspense, {
        fallback: (0, import_jsx_runtime.jsx)(Page.Loading, {}),
        children: (0, import_jsx_runtime.jsxs)(Routes, {
          children: [
            (0, import_jsx_runtime.jsx)(Route, {
              index: true,
              element: (0, import_jsx_runtime.jsx)(MediaLibrary, {})
            }),
            (0, import_jsx_runtime.jsx)(Route, {
              path: "configuration",
              element: (0, import_jsx_runtime.jsx)(ConfigureTheView, {
                config
              })
            })
          ]
...
//# sourceMappingURL=App-Dyo0gLZ1-CTPXSA2J.js.map
