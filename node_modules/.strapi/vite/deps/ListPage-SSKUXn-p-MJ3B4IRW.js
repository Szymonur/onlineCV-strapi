...
// node_modules/@strapi/admin/dist/admin/chunks/ListPage-SSKUXn-p.mjs
  ...
  return (0, import_jsx_runtime.jsxs)(Page.Main, {
    ...
    children: [
      ...
      (0, import_jsx_runtime.jsx)(Layouts.Action, {
        startActions: (0, import_jsx_runtime.jsxs)(Filters.Root, {
            ...
            children: (0, import_jsx_runtime.jsxs)(Table.Content, {
              children: [
                ...
                (0, import_jsx_runtime.jsx)(Table.Body, {
                  children: results.map((log) => (0, import_jsx_runtime.jsxs)(Table.Row, {
                    onClick: () => setQuery({
                      id: log.id
                    }),
                    children: [
      ...
      (query == null ? void 0 : query.id) && (0, import_jsx_runtime.jsx)(Modal2, {
...
//# sourceMappingURL=ListPage-SSKUXn-p-MJ3B4IRW.js.map
