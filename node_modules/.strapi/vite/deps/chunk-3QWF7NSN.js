...
import {
  require_sortBy
} from "./chunk-WTXR2LVB.js";
import {
  require_groupBy
} from "./chunk-G2RJXBLX.js";
import {
...
} from "./chunk-KPHBV4L5.js";
import {
  require_pluralize
} from "./chunk-XNACAI67.js";
import {
  formatISO
} from "./chunk-NIENZRAG.js";
import {
  ConfirmDialog,
  Layouts,
  create3 as create,
...
// node_modules/@strapi/content-type-builder/dist/admin/chunks/index-Knq4Ti8R.mjs
  ...
  return (0, import_jsx_runtime.jsxs)(SubNav, {
    ...
    children: [
      ...
      (0, import_jsx_runtime.jsx)(SubNavSections, {
        children: menu.map((section) => (0, import_jsx_runtime.jsxs)(import_react.Fragment, {
          children: [
...
var AllowedTypesSelect = ({ intlLabel, name, onChange, value = null }) => {
  ...
  const displayedValue = value === null || (value == null ? void 0 : value.length) === 0 ? formatMessage({
    ...
    ...value
  ].sort().map((v) => (0, import_upperFirst.default)(v)).join(", ");
  ...
  return (0, import_jsx_runtime.jsxs)(Field.Root, {
    ...
    children: [
      ...
      (0, import_jsx_runtime.jsx)(MultiSelectNested, {
...
`;
var newAttributes = [];
var NewBadge = () => (0, import_jsx_runtime.jsx)(Flex, {
  grow: 1,
...
var AttributeOption = ({ type = "text" }) => {
  ...
  return (0, import_jsx_runtime.jsx)(OptionBoxWrapper, {
    padding: 4,
    tag: "button",
    hasRadius: true,
    type: "button",
    ...
    children: (0, import_jsx_runtime.jsxs)(Flex, {
      children: [
        (0, import_jsx_runtime.jsx)(AttributeIcon, {
          type
        }),
...
var AttributeList = ({ attributes }) => (0, import_jsx_runtime.jsx)(KeyboardNavigable, {
  tagName: "button",
    ...
    children: attributes.map((attributeRow, index2) => {
      return (
        ...
        (0, import_jsx_runtime.jsx)(Grid.Root, {
          gap: 3,
          children: attributeRow.map((attribute) => (0, import_jsx_runtime.jsx)(Grid.Item, {
            col: 6,
            direction: "column",
            alignItems: "stretch",
            children: (0, import_jsx_runtime.jsx)(AttributeOption, {
              type: attribute
            })
          }, attribute))
        }, index2)
...
var EmptyCardGrid = () => {
  return (0, import_jsx_runtime.jsx)(Flex, {
    ...
    children: [
      ...
      return (0, import_jsx_runtime.jsx)(EmptyCard, {
        height: "138px",
        width: "375px",
        hasRadius: true
      }, `empty-card-${idx}`);
    ...
    children: [
      ...
      (0, import_jsx_runtime.jsx)(Box, {
        ...
        children: (0, import_jsx_runtime.jsxs)(Flex, {
          ...
          direction: "column",
          children: [
            (0, import_jsx_runtime.jsx)(ForwardRef$J2, {
              width: "160px",
              height: "88px"
            }),
            (0, import_jsx_runtime.jsx)(Box, {
...
var CustomFieldsList = () => {
  ...
  return (0, import_jsx_runtime.jsx)(KeyboardNavigable, {
    tagName: "button",
    children: (0, import_jsx_runtime.jsxs)(Flex, {
      direction: "column",
      alignItems: "stretch",
      ...
      children: [
        (0, import_jsx_runtime.jsx)(Grid.Root, {
          gap: 3,
          children: sortedCustomFields.map(([uid, customField]) => (0, import_jsx_runtime.jsx)(Grid.Item, {
            col: 6,
            direction: "column",
            alignItems: "stretch",
            children: (0, import_jsx_runtime.jsx)(CustomFieldOption, {
              customFieldUid: uid,
              customField
            }, uid)
          }, uid))
        }),
        (0, import_jsx_runtime.jsx)(Link2, {
...
var AttributeOptions = ({ attributes, forTarget, kind }) => {
  ...
  return (0, import_jsx_runtime.jsx)(Modal.Body, {
    children: (0, import_jsx_runtime.jsxs)(Tabs.Root, {
      ...
      children: [
        ...
        (0, import_jsx_runtime.jsx)(Tabs.Content, {
          value: "default",
          children: (0, import_jsx_runtime.jsx)(AttributeList, {
            attributes
          })
        }),
        (0, import_jsx_runtime.jsx)(Tabs.Content, {
          value: "custom",
          children: (0, import_jsx_runtime.jsx)(CustomFieldsList, {})
        })
      ]
    })
  });
...
var CustomRadioGroup = ({ intlLabel, name, onChange, radios = [], value }) => {
  ...
  return (0, import_jsx_runtime.jsxs)(Flex, {
    ...
    children: [
      ...
      (0, import_jsx_runtime.jsx)(Wrapper$1, {
        gap: 4,
        alignItems: "stretch",
...
var BooleanRadioGroup = ({ onChange, name, intlLabel, ...rest }) => {
  ...
  return (0, import_jsx_runtime.jsx)(CustomRadioGroup, {
    ...rest,
    name,
    onChange: handleChange,
    intlLabel
...
var CheckboxWithNumberField = ({ error, intlLabel, modifiedData, name, onChange, value = null }) => {
  ...
  return (0, import_jsx_runtime.jsxs)(Flex, {
    ...
    children: [
      ...
      value !== null && (0, import_jsx_runtime.jsx)(Box, {
        paddingLeft: 6,
        style: {
          maxWidth: "200px"
        },
        children: type === "text" ? (0, import_jsx_runtime.jsxs)(Field.Root, {
          error: errorMessage,
          name,
          children: [
...
var FormModalEndActions = ({ categoryName, deleteCategory, deleteComponent, deleteContentType, isAttributeModal, isCustomFieldModal, isComponentAttribute, isComponentToDzModal, isContentTypeModal, isCreatingComponent, isCreatingComponentAttribute, isCreatingComponentInDz, isCreatingComponentWhileAddingAField, isCreatingContentType, isCreatingDz, isComponentModal, isDzAttribute, isEditingAttribute, isEditingCategory, isInFirstComponentStep, onSubmitAddComponentAttribute, onSubmitAddComponentToDz, onSubmitCreateContentType, onSubmitCreateComponent, onSubmitCreateDz, onSubmitEditAttribute, onSubmitEditCategory, onSubmitEditComponent, onSubmitEditContentType, onSubmitEditCustomFieldAttribute, onSubmitEditDz, onClickFinish }) => {
  ...
  if (isContentTypeModal) {
    return (0, import_jsx_runtime.jsxs)(Flex, {
      gap: 2,
      children: [
        !isCreatingContentType && (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, {
          children: [
            (0, import_jsx_runtime.jsx)(Button, {
              type: "button",
              variant: "danger",
        ...
        isCreatingContentType && (0, import_jsx_runtime.jsx)(Button, {
          type: "submit",
          variant: "secondary",
          onClick: (e) => {
            e.preventDefault();
  ...
  if (isComponentModal) {
    return (0, import_jsx_runtime.jsxs)(Flex, {
      gap: 2,
      children: [
        !isCreatingComponent && (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, {
          children: [
            (0, import_jsx_runtime.jsx)(Button, {
              type: "button",
              variant: "danger",
        ...
        isCreatingComponent && (0, import_jsx_runtime.jsx)(Button, {
          type: "submit",
          variant: "secondary",
          onClick: (e) => {
            e.preventDefault();
...
var FormModalHeader = ({ actionType = null, attributeName, attributeType, categoryName, contentTypeKind, dynamicZoneTarget, forTarget, modalType = null, targetUid, customFieldUid = null, showBackLink = false }) => {
  ...
  if (isCreatingMainSchema) {
    ...
    return (0, import_jsx_runtime.jsx)(Modal.Header, {
      children: (0, import_jsx_runtime.jsxs)(Flex, {
        children: [
          (0, import_jsx_runtime.jsx)(Box, {
            children: (0, import_jsx_runtime.jsx)(AttributeIcon, {
              type: icon
            })
          }),
          (0, import_jsx_runtime.jsx)(Box, {
  ...
  return (0, import_jsx_runtime.jsx)(Modal.Header, {
    children: (0, import_jsx_runtime.jsxs)(Flex, {
      ...
      children: [
        ...
        (0, import_jsx_runtime.jsx)(Breadcrumbs, {
          ...
          children: headers.map(({ label, info }, index2, arr) => {
            ...
            return (0, import_jsx_runtime.jsx)(Crumb, {
...
var IconPick = ({ iconKey, name, onChange, isSelected, ariaLabel }) => {
  ...
  return (0, import_jsx_runtime.jsx)(Field.Root, {
    name,
    required: false,
    children: (0, import_jsx_runtime.jsxs)(Field.Label, {
      children: [
        (0, import_jsx_runtime.jsxs)(VisuallyHidden, {
          children: [
            ariaLabel,
            (0, import_jsx_runtime.jsx)(Field.Input, {
              type: "radio",
              checked: isSelected,
              onChange,
              value: iconKey,
...
var IconPicker = ({ intlLabel, name, onChange, value = "" }) => {
  ...
  return (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, {
    children: [
      (0, import_jsx_runtime.jsxs)(Flex, {
        ...
        children: [
          ...
          (0, import_jsx_runtime.jsxs)(Flex, {
            gap: 1,
            children: [
              showSearch ? (0, import_jsx_runtime.jsx)(Searchbar, {
                ref: searchBarRef,
                name: "searchbar",
              ...
              value && (0, import_jsx_runtime.jsx)(TooltipImpl, {
                label: formatMessage({
      ...
      (0, import_jsx_runtime.jsx)(IconPickerWrapper, {
        position: "relative",
        padding: 1,
        ...
        overflow: "auto",
        textAlign: "center",
        children: icons.length > 0 ? icons.map((iconKey) => (0, import_jsx_runtime.jsx)(IconPick, {
          iconKey,
          name,
          onChange,
        ...
        }, iconKey)) : (0, import_jsx_runtime.jsx)(Box, {
          padding: 4,
          grow: 2,
          children: (0, import_jsx_runtime.jsx)(Typography, {
            variant: "delta",
...
var GenericInput = ({ autoComplete, customInputs, description, disabled, intlLabel, labelAction, error, name, onChange, options: options2 = [], placeholder, required, step, type, value: defaultValue, isNullable, attribute, ...rest }) => {
  ...
  const getComponent = () => {
    switch (type) {
      case "json": {
        return (0, import_jsx_runtime.jsx)(JSONInput, {
          value,
          disabled,
          onChange: (json) => {
      ...
      case "bool": {
        return (0, import_jsx_runtime.jsx)(Toggle, {
      ...
      case "checkbox": {
        return (0, import_jsx_runtime.jsx)(CheckboxImpl, {
          disabled,
          onCheckedChange: (value2) => {
            onChange({
              target: {
      ...
      case "datetime": {
        ...
        return (0, import_jsx_runtime.jsx)(DateTimePicker, {
          clearLabel: formatMessage({
            id: "clearLabel",
      ...
      case "date": {
        const dateValue = parseDateValue(value);
        return (0, import_jsx_runtime.jsx)(DatePicker$1, {
          clearLabel: formatMessage({
            id: "clearLabel",
            defaultMessage: "Clear"
          }),
      ...
      case "number": {
        return (0, import_jsx_runtime.jsx)(NumberInput, {
          disabled,
          onValueChange: (value2) => {
            onChange({
              target: {
      ...
      case "time": {
        ...
        return (0, import_jsx_runtime.jsx)(TimePicker$1, {
          clearLabel: formatMessage({
            id: "clearLabel",
            defaultMessage: "Clear"
          }),
  ...
  return (0, import_jsx_runtime.jsxs)(Field.Root, {
    ...
    required,
    children: [
      type !== "checkbox" ? (0, import_jsx_runtime.jsx)(Field.Label, {
        action: labelAction,
        children: label
      }) : null,
      getComponent(),
...
var RelationTargetPicker = ({ oneThatIsCreatingARelationWithAnother, target }) => {
  ...
  return (0, import_jsx_runtime.jsxs)(Menu.Root, {
    children: [
      (0, import_jsx_runtime.jsx)(MenuTrigger, {
        children: `${displayName} ${plugin ? `(from: ${plugin})` : ""}`
      }),
      (0, import_jsx_runtime.jsx)(Menu.Content, {
        zIndex: "popover",
        children: allowedContentTypesForRelation.map(({ uid, title, restrictRelationsTo, plugin: plugin2 }) => (0, import_jsx_runtime.jsxs)(Menu.Item, {
          ...
          children: [
            title,
            " ",
            plugin2 && (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, {
              children: [
                "(from: ",
                plugin2,
                ")"
  ...
  return (0, import_jsx_runtime.jsxs)(Box, {
    ...
    children: [
      (0, import_jsx_runtime.jsx)(Flex, {
        ...
        justifyContent: "center",
        children: isMain ? (0, import_jsx_runtime.jsx)(Typography, {
          variant: "pi",
          fontWeight: "bold",
          textColor: "neutral800",
          children: header
        }) : (0, import_jsx_runtime.jsx)(RelationTargetPicker, {
          target,
          oneThatIsCreatingARelationWithAnother
        })
      }),
      ...
      (0, import_jsx_runtime.jsx)(Box, {
        padding: 4,
        children: (0, import_jsx_runtime.jsx)(MemoizedGenericInput, {
          disabled,
...
var RelationNaturePicker = ({ naturePickerType, oneThatIsCreatingARelationWithAnother, relationType, target }) => {
  ...
  const rightDisplayedValue = (0, import_pluralize.default)(rightTarget, [
    "manyToMany",
    "oneToMany",
    "manyToOne",
    "manyWay"
  ...
  return (0, import_jsx_runtime.jsxs)(Flex, {
    ...
    children: [
      (0, import_jsx_runtime.jsx)(Wrapper, {
        children: (0, import_jsx_runtime.jsx)(Flex, {
          paddingLeft: 9,
          paddingRight: 9,
          paddingTop: 1,
          justifyContent: "center",
          children: (0, import_jsx_runtime.jsx)(KeyboardNavigable, {
            tagName: "button",
            children: (0, import_jsx_runtime.jsx)(Flex, {
              gap: 3,
              children: relationsType.map((relation) => {
                ...
                return (0, import_jsx_runtime.jsx)(IconWrapper, {
                  tag: "button",
                  ...
                  children: (0, import_jsx_runtime.jsx)(Asset, {
                    "aria-hidden": "true"
                  }, relation)
                }, relation);
              })
      ...
      (0, import_jsx_runtime.jsxs)(InfosWrapper, {
        justifyContent: "center",
        children: [
...
var Relation = ({ formErrors, mainBoxHeader, modifiedData, naturePickerType, onChange }) => {
  ...
  return (0, import_jsx_runtime.jsxs)(Flex, {
    ...
    children: [
      (0, import_jsx_runtime.jsx)(RelationFormBox, {
        isMain: true,
      ...
      (0, import_jsx_runtime.jsx)(RelationNaturePicker, {
        naturePickerType,
  ...
  return (0, import_jsx_runtime.jsxs)(Field.Root, {
    ...
    children: [
      ...
      (0, import_jsx_runtime.jsx)(Combobox, {
        ...
        value,
        creatable: true,
        children: categories.map((category) => (0, import_jsx_runtime.jsx)(Option, {
          value: category,
          children: category
        }, category))
      }),
...
var TabForm = ({ form, formErrors, genericInputProps, modifiedData, onChange }) => {
  ...
  return (0, import_jsx_runtime.jsx)(import_jsx_runtime.Fragment, {
    children: form.map((section, sectionIndex) => {
      ...
      return (0, import_jsx_runtime.jsxs)(Box, {
        children: [
          section.sectionTitle && (0, import_jsx_runtime.jsx)(Box, {
            paddingBottom: 4,
            children: (0, import_jsx_runtime.jsx)(Typography, {
              variant: "delta",
              tag: "h3",
          ...
          (0, import_jsx_runtime.jsx)(Grid.Root, {
            ...
            children: section.items.map((input, i) => {
              ...
              const errorId = pluginOptionError ? formErrors[pluginOptionError].id : (0, import_get.default)(formErrors, [
    ...
    const shape = {
      ...
      enum: create5().of(create2()).min(1, errorsTrads.min.id).test({
        ...
        test(values) {
          ...
          const duplicates = (0, import_uniq.default)(values.map(toRegressedEnumValue).filter((value, index2, values2) => values2.indexOf(value) !== index2));
  ...
  const shape = {
    displayName: create2().test({
      ...
      test(value) {
        ...
        }) && takenCollectionNames.every((collectionName) => (0, import_fp.snakeCase)(collectionName) !== snakeCaseCollectionName);
      }
    }).test({
      name: "nameNotAllowed",
...
var canEditContentType = (data, modifiedData) => {
  const kind = (0, import_get.default)(data, [
    "contentType",
    "schema",
    "kind"
  ], "");
  ...
  const contentTypeAttributes = (0, import_get.default)(data, [
    "contentType",
    "schema",
    "attributes"
  ], []);
...
var FormModal = () => {
  ...
  React.useEffect(() => {
    if (isOpen) {
      ...
      if (modalType === "contentType" && actionType === "edit") {
        const { displayName, draftAndPublish, kind: kind2, pluginOptions, pluralName, singularName } = (0, import_get.default)(allDataSchema, [
          ...pathToSchema,
          "schema"
        ], {
          displayName: null,
      ...
      if (attributeType) {
        const attributeToEditNotFormatted = findAttribute((0, import_get.default)(allDataSchema, pathToAttributes, []), attributeName);
        const attributeToEdit = {
        ...
        if (modalType === "customField") {
          ...
          dispatch(actions.setAttributeDataSchema({
            attributeType,
            nameToSetForRelation: (0, import_get.default)(collectionTypesForRelation, [
              "0",
              "title"
            ], "error"),
            targetUid: (0, import_get.default)(collectionTypesForRelation, [
              "0",
              "uid"
            ], "error"),
  ...
  const attributes = (0, import_get.default)(allDataSchema, [
    ...pathToSchema,
    "schema",
    "attributes"
  ], null);
  const checkFormValidity = async () => {
    ...
    if (isCreatingContentType) {
      schema = forms.contentType.schema(
        ...
        actionType === "edit",
        // currentUID
        (0, import_get.default)(allDataSchema, [
          ...pathToSchema,
          "uid"
        ], null),
        reservedNames,
      ...
      schema = forms.component.schema(Object.keys(components), modifiedData.category || "", reservedNames, actionType === "edit", components, modifiedData.displayName || "", (0, import_get.default)(allDataSchema, [
        ...pathToSchema,
        "uid"
      ], null));
    } else if (isCreatingCustomFieldAttribute) {
      schema = forms.customField.schema({
        schemaAttributes: (0, import_get.default)(allDataSchema, [
          ...pathToSchema,
          "schema",
          "attributes"
        ], []),
      ...
      schema = forms.component.schema(Object.keys(components), (0, import_get.default)(modifiedData, "componentToCreate.category", ""), reservedNames, actionType === "edit", components, modifiedData.componentToCreate.displayName || "");
      ...
      if (type === "relation") {
        const targetContentTypeUID = (0, import_get.default)(modifiedData, [
          "target"
        ], null);
        const targetContentTypeAttributes = (0, import_get.default)(contentTypes, [
      ...
      schema = forms.attribute.schema((0, import_get.default)(allDataSchema, pathToSchema, {}), type, reservedNames, alreadyTakenTargetContentTypeAttributes, {
        modifiedData,
        initialData
      }, ctbFormsAPI);
  ...
  const formToDisplay = (0, import_get.default)(forms, [
    modalType,
    "form"
  ], {
    advanced: () => ({
  ...
  const genericInputProps = {
    ...
    mainBoxHeader: (0, import_get.default)(allDataSchema, [
      ...pathToSchema,
      "schema",
      "displayName"
    ], ""),
  ...
  const schemaKind = (0, import_get.default)(contentTypes, [
    targetUid,
    "schema",
    "kind"
  ]);
  ...
  return (0, import_jsx_runtime.jsx)(Modal.Root, {
    ...
    children: (0, import_jsx_runtime.jsxs)(Modal.Content, {
      children: [
        (0, import_jsx_runtime.jsx)(FormModalHeader, {
          actionType,
          attributeName,
          categoryName,
        ...
        isPickingAttribute && (0, import_jsx_runtime.jsx)(AttributeOptions, {
          attributes: displayedAttributes,
          forTarget,
          kind: schemaKind || "collectionType"
        }),
        !isPickingAttribute && (0, import_jsx_runtime.jsxs)(FormComponent, {
          ...
          children: [
              ...
              children: (0, import_jsx_runtime.jsxs)(Tabs.Root, {
                ...
                children: [
                  (0, import_jsx_runtime.jsxs)(Flex, {
                    justifyContent: "space-between",
                    children: [
                      (0, import_jsx_runtime.jsx)(FormModalSubHeader, {
                        actionType,
                        forTarget,
                        kind,
                        step,
                  ...
                  (0, import_jsx_runtime.jsx)(Tabs.Content, {
                    ...
                    children: (0, import_jsx_runtime.jsx)(Flex, {
                      ...
                      alignItems: "stretch",
                      gap: 6,
                      children: (0, import_jsx_runtime.jsx)(TabForm, {
                        form: baseForm2,
                        formErrors,
                        genericInputProps,
                        modifiedData,
            ...
            (0, import_jsx_runtime.jsxs)(Modal.Footer, {
              children: [
                ...
                (0, import_jsx_runtime.jsx)(FormModalEndActions, {
                  deleteCategory,
...
var getCreatedAndModifiedComponents = (allComponents, initialComponents) => {
  const componentUIDsToReturn = Object.keys(allComponents).filter((compoUid) => {
    ...
    const hasComponentBeenCreated = (0, import_get.default)(currentCompo, [
      "isTemporary"
    ], false);
...
var formatComponent = (component, mainDataUID) => {
  const formattedAttributes = formatAttributes((0, import_get.default)(component, "schema.attributes", []), mainDataUID);
  const compoUID = (0, import_get.default)(component, "isTemporary", false) ? {
...
var formatMainDataType = (data, isComponent = false) => {
  ...
  const initObj = isComponent ? {
    category: (0, import_get.default)(data, "category", "")
  } : {};
...
var getComponentWithChildComponents = (component) => {
  const attributes = (0, import_get.default)(component, [
    "schema",
    "attributes"
  ], []);
  return {
...
var retrieveSpecificInfoFromComponents = (allComponents, keysToRetrieve) => {
  const allData = Object.keys(allComponents).map((compo) => {
    return (0, import_get.default)(allComponents, [
      compo,
      ...keysToRetrieve
    ], "");
  });
...
var DataManagerProvider = ({ children }) => {
  ...
  (0, import_react.useEffect)(() => {
    getDataRef.current();
    return () => {
      dispatch(actions$1.reloadPlugin());
    };
  }, []);
  (0, import_react.useEffect)(() => {
  ...
  const addAttribute = (attributeToSet, forTarget, targetUid, isEditing = false, initialAttribute, shouldAddComponentToData = false) => {
    if (isEditing) {
      ...
      dispatch(actions$1.editAttribute(payload));
    } else {
      const payload = {
        attributeToSet,
        forTarget,
      ...
      dispatch(actions$1.addAttribute(payload));
    }
  };
  const addCustomFieldAttribute = ({ attributeToSet, forTarget, targetUid }) => {
    dispatch(actions$1.addCustomFieldAttribute({
      attributeToSet,
      forTarget,
      targetUid
    }));
  ...
  const editCustomFieldAttribute = ({ attributeToSet, forTarget, targetUid, initialAttribute }) => {
    dispatch(actions$1.editCustomFieldAttribute({
      attributeToSet,
      forTarget,
      targetUid,
      initialAttribute
  ...
  const addCreatedComponentToDynamicZone = (dynamicZoneTarget, componentsToAdd) => {
    dispatch(actions$1.addCreatedComponentToDynamicZone({
      dynamicZoneTarget,
      componentsToAdd
    }));
  };
  const createSchema = (data, schemaType, uid, componentCategory, shouldAddComponentToData = false) => {
    if (schemaType === "contentType") {
      ...
      dispatch(actions$1.createSchema(payload));
    } else {
      const payload = {
        data,
        uid,
      ...
      dispatch(actions$1.createComponentSchema(payload));
    }
  };
  const changeDynamicZoneComponents = (dynamicZoneTarget, newComponents) => {
    dispatch(actions$1.changeDynamicZoneComponents({
      dynamicZoneTarget,
      newComponents
    }));
  };
  const removeAttribute = (mainDataKey, attributeToRemoveName, componentUid = "") => {
    if (mainDataKey === "components") {
      dispatch(actions$1.removeFieldFromDisplayedComponent({
      ...
      dispatch(actions$1.removeField({
        mainDataKey,
        attributeToRemoveName
      }));
    }
  ...
  const deleteData = async () => {
    try {
      ...
      const isTemporary = (0, import_get.default)(modifiedData, [
      ...
      if (userConfirm) {
        if (isTemporary) {
          dispatch(actions$1.deleteNotSavedType());
          return;
        }
        lockAppWithAutoreload == null ? void 0 : lockAppWithAutoreload();
        await del(requestURL);
  ...
  const getAllComponentsThatHaveAComponentInTheirAttributes = () => {
    ...
    if (!isInContentTypeView) {
      ...
      (0, import_set.default)(allCompos, (0, import_get.default)(currentEditedCompo, [
        "uid"
      ], ""), currentEditedCompo);
    }
  ...
  const removeComponentFromDynamicZone = (dzName, componentToRemoveIndex) => {
    dispatch(actions$1.removeComponentFromDynamicZone({
      dzName,
  ...
  const setModifiedData = () => {
    ...
    dispatch(actions$1.setModifiedData({
  ...
  const redirectEndpoint = (0, import_react.useMemo)(() => {
    const allowedEndpoints = Object.keys(contentTypes).filter((uid) => (0, import_get.default)(contentTypes, [
      uid,
      "schema",
      "visible"
    ], true)).sort();
  ...
  const submitData = async (additionalContentTypeData) => {
    var _a, _b, _c;
    try {
      const isCreating = (0, import_get.default)(modifiedData, [
        firstKeyToMainSchema,
        "isTemporary"
      ], false);
      const body = {
      ...
      if (isInContentTypeView) {
        ...
        const oldName = (0, import_get.default)(body, [
          "contentType",
          "schema",
          "name"
        ], "");
        const newName = (0, import_get.default)(initialData, [
          "contentType",
          "schema",
          "name"
        ], "");
  ...
  const updateSchema = (data, schemaType, componentUID) => {
    dispatch(actions$1.updateSchema({
      data,
      schemaType,
      uid: componentUID
    }));
  };
  return (0, import_jsx_runtime.jsxs)(DataManagerContext.Provider, {
    value: {
      addAttribute,
...
var FormModalNavigationProvider = ({ children }) => {
  ...
  return (0, import_jsx_runtime.jsx)(FormModalNavigationContext.Provider, {
    value: {
      ...state,
      onClickSelectField,
      onClickSelectCustomField,
...
var ListView = (0, import_react.lazy)(() => import("./ListView-Cl-pbcxP-K3PR3QUP.js"));
var App = () => {
  const { formatMessage } = useIntl();
  ...
  return (0, import_jsx_runtime.jsxs)(Page.Protect, {
    ...
    children: [
      ...
      (0, import_jsx_runtime.jsx)(AutoReloadOverlayBlockerProvider, {
        children: (0, import_jsx_runtime.jsx)(FormModalNavigationProvider, {
          children: (0, import_jsx_runtime.jsx)(DataManagerProvider$1, {
            children: (0, import_jsx_runtime.jsx)(Layouts.Root, {
              sideNav: (0, import_jsx_runtime.jsx)(ContentTypeBuilderNav, {}),
              children: (0, import_jsx_runtime.jsx)(import_react.Suspense, {
                fallback: (0, import_jsx_runtime.jsx)(Page.Loading, {}),
                children: (0, import_jsx_runtime.jsxs)(Routes, {
                  children: [
                    (0, import_jsx_runtime.jsx)(Route, {
                      path: "content-types/:uid",
                      element: (0, import_jsx_runtime.jsx)(ListView, {})
                    }),
                    (0, import_jsx_runtime.jsx)(Route, {
...
lodash/lodash.min.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-3QWF7NSN.js.map
