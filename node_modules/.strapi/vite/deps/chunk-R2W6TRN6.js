...
// node_modules/@strapi/i18n/dist/admin/chunks/index--VTS8j_L.mjs
...
var BulkLocaleActionModal = ({ headers, rows, localesMetadata, validationErrors = {}, action }) => {
  ...
  return (0, import_jsx_runtime.jsxs)(Modal.Body, {
    children: [
      (0, import_jsx_runtime.jsx)(Typography, {
          ...
          children: [
            (0, import_jsx_runtime.jsxs)(Table.Head, {
              children: [
                ...
                headers.map((head) => (0, import_jsx_runtime.jsx)(Table.HeaderCell, {
                  ...head
                }, head.name))
              ]
            }),
            (0, import_jsx_runtime.jsx)(Table.Body, {
              children: rows.map(({ locale, status }, index2) => {
                var _a;
                  ...
                  children: [
                    ...
                    (0, import_jsx_runtime.jsx)(Table.Cell, {
                      children: (0, import_jsx_runtime.jsx)(Box, {
                        display: "flex",
                        children: (0, import_jsx_runtime.jsx)(Status, {
                          display: "flex",
                          paddingLeft: "6px",
                          paddingRight: "6px",
                          paddingTop: "2px",
                    ...
                    (0, import_jsx_runtime.jsx)(Table.Cell, {
                      children: (0, import_jsx_runtime.jsx)(EntryValidationText, {
...
var LocaleOption = ({ isDraftAndPublishEnabled, locale, status, entryExists }) => {
  ...
  if (!entryExists) {
    return formatMessage({
      ...
      bold: (locale2) => (0, import_jsx_runtime.jsx)("b", {
        children: locale2
      }),
      locale: locale.name
    });
  ...
  return (0, import_jsx_runtime.jsxs)(Flex, {
    ...
    children: [
      ...
      isDraftAndPublishEnabled ? (0, import_jsx_runtime.jsx)(Status, {
        display: "flex",
        paddingLeft: "6px",
        paddingRight: "6px",
        paddingTop: "2px",
  ...
  return {
    ...
    options: displayedLocales.map((locale) => {
      ...
      return {
        ...
        value: locale.code,
        label: (0, import_jsx_runtime.jsx)(LocaleOption, {
        ...
        startIcon: !entryWithLocaleExists ? (0, import_jsx_runtime.jsx)(ForwardRef$1h, {}) : null
      };
    }),
...
var FillFromAnotherLocaleAction = ({ documentId, meta, model, collectionType }) => {
  ...
  return {
    type: "icon",
    icon: (0, import_jsx_runtime.jsx)(ForwardRef$3P, {}),
    ...
    dialog: {
      ...
      content: ({ onClose }) => (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, {
        children: [
          (0, import_jsx_runtime.jsx)(Dialog.Body, {
            children: (0, import_jsx_runtime.jsxs)(Flex, {
              direction: "column",
                ...
                (0, import_jsx_runtime.jsxs)(Field.Root, {
                  ...
                  children: [
                    ...
                    (0, import_jsx_runtime.jsx)(SingleSelect, {
                      ...
                      children: availableLocales.map((locale) => (0, import_jsx_runtime.jsx)(SingleSelectOption, {
                        value: locale.code,
                        children: locale.name
                      }, locale.code))
                    })
          ...
          (0, import_jsx_runtime.jsx)(Dialog.Footer, {
            children: (0, import_jsx_runtime.jsxs)(Flex, {
              gap: 2,
              width: "100%",
              children: [
...
var BulkLocaleAction = ({ document, documentId, model, collectionType, action }) => {
  ...
  return {
    ...
    icon: isBulkPublish ? (0, import_jsx_runtime.jsx)(ForwardRef$2n, {}) : (0, import_jsx_runtime.jsx)(ForwardRef$45, {}),
    ...
    dialog: {
      ...
      content: () => {
        return (0, import_jsx_runtime.jsx)(Table.Root, {
          ...
          children: (0, import_jsx_runtime.jsx)(BulkLocaleActionModal, {
            validationErrors,
            headers,
            rows,
            localesMetadata,
      ...
      footer: () => (0, import_jsx_runtime.jsx)(Modal.Footer, {
...
var LocalePicker = () => {
  ...
  return (0, import_jsx_runtime.jsx)(SingleSelect, {
    ...
    children: displayedLocales.map((locale) => (0, import_jsx_runtime.jsx)(SingleSelectOption, {
      value: locale.code,
      children: locale.name
    }, locale.id))
  });
...
var addLabelActionToField = (field) => {
  ...
  const labelActionProps = {
    ...
    icon: isFieldLocalized ? (0, import_jsx_runtime.jsx)(ForwardRef$3P, {}) : null
  };
  return {
    ...field,
    labelAction: isFieldLocalized ? (0, import_jsx_runtime.jsx)(LabelAction, {
      ...labelActionProps
    }) : null
  };
};
    ...
    children: [
      ...
      (0, import_jsx_runtime.jsx)(Popover.Content, {
        ...
        children: (0, import_jsx_runtime.jsx)("ul", {
          children: localesForDocument.map((name) => (0, import_jsx_runtime.jsx)(Box, {
            padding: 3,
            tag: "li",
            children: (0, import_jsx_runtime.jsx)(Typography, {
              children: name
  ...
  return {
    displayedHeaders: [
      ...displayedHeaders,
      {
        ...
        cellFormatter: (props, _header, meta) => (0, import_jsx_runtime.jsx)(LocaleListCell, {
          ...props,
          ...meta
        })
      }
  ...
  return ({ getState }) => (next) => (action) => {
    const enhanceAction = () => {
      try {
        ...
        const hasi18nEnabled = (0, import_get.default)(store, [
...
function __variableDynamicImportRuntime1__(path) {
  switch (path) {
    case "./translations/de.json":
      return import("./de-Cm8mYdaO-LMBAYVQL.js");
    case "./translations/dk.json":
      return import("./dk-BeUFOegB-NQBC7R7W.js");
    case "./translations/en.json":
      return import("./en-eWSaCeOb-3QR4OMMY.js");
    case "./translations/es.json":
      return import("./es-DqF_IdAc-VEQVGL6T.js");
    case "./translations/fr.json":
      return import("./fr-CyARbZ3c-R7CFHZY6.js");
    case "./translations/ko.json":
      return import("./ko-Ax4NSedM-7W2ZR23N.js");
    case "./translations/pl.json":
      return import("./pl-B-aqvMqL-HDDGHJE3.js");
    case "./translations/ru.json":
      return import("./ru-VkPjQ-Sk-XZYSB4PZ.js");
    case "./translations/tr.json":
      return import("./tr-DcTR88c9-R76I5B6P.js");
    case "./translations/uk.json":
      return import("./uk-CMz6iPag-SCIBGWXB.js");
    case "./translations/zh-Hans.json":
      return import("./zh-Hans-L3wsRegj-TJOSPPGF.js");
    case "./translations/zh.json":
      return import("./zh-RZyMiPIs-HN3336SY.js");
    default:
...
var index = {
  ...
  bootstrap(app) {
    ...
    app.addSettingsLink("global", {
      ...
      Component: () => import("./SettingsPage-BOEeBbiM-5OXZRGM3.js").then((mod) => ({
      ...
      ctbFormsAPI.extendFields(LOCALIZED_FIELDS, {
        form: {
          advanced({ contentTypeSchema, forTarget, type, step }) {
            ...
            const hasI18nEnabled = (0, import_get.default)(contentTypeSchema, [
              "schema",
              "pluginOptions",
              "i18n",
              "localized"
...
//# sourceMappingURL=chunk-R2W6TRN6.js.map
