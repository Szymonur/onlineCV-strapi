...
// node_modules/@strapi/content-manager/dist/admin/chunks/Form-BrzQyDxU.mjs
    ...
    children: [
      ...
      (0, import_jsx_runtime.jsx)(Box, {
        ...
        children: (0, import_jsx_runtime.jsxs)(Flex, {
          ...
          gap: 2,
          children: [
            layout.map((row, rowIndex) => (0, import_jsx_runtime.jsx)(Grid.Root, {
              gap: 2,
              children: row.children.map(({ size, ...field }, fieldIndex) => (0, import_jsx_runtime.jsx)(Grid.Item, {
                col: size,
                direction: "column",
                alignItems: "stretch",
                children: (0, import_jsx_runtime.jsx)(Field, {
            ...
            (0, import_jsx_runtime.jsxs)(Menu.Root, {
              children: [
                ...
                (0, import_jsx_runtime.jsx)(Menu.Content, {
                  children: remainingFields.map((field) => (0, import_jsx_runtime.jsx)(Menu.Item, {
...
var Field = ({ attribute, components, name, index, onMoveField, onRemoveField }) => {
  ...
  return (0, import_jsx_runtime.jsxs)(Modal.Root, {
    ...
    children: [
        ...
        children: [
          ...
          (0, import_jsx_runtime.jsxs)(Flex, {
            ...
            children: [
              ...
              (attribute == null ? void 0 : attribute.type) === "component" ? (0, import_jsx_runtime.jsxs)(Flex, {
                paddingTop: 3,
                paddingRight: 3,
                paddingBottom: 3,
                paddingLeft: 0,
                ...
                children: [
                  (0, import_jsx_runtime.jsx)(Grid.Root, {
                    gap: 4,
                    width: "100%",
                    children: components[attribute.component].layout.map((row) => row.map(({ size, ...field }) => (0, import_jsx_runtime.jsx)(Grid.Item, {
                      col: size,
                      direction: "column",
                      alignItems: "stretch",
              ...
              (attribute == null ? void 0 : attribute.type) === "dynamiczone" ? (0, import_jsx_runtime.jsx)(Flex, {
                paddingTop: 3,
                paddingRight: 3,
                paddingBottom: 3,
                paddingLeft: 0,
                ...
                gap: 2,
                width: "100%",
                children: attribute == null ? void 0 : attribute.components.map((uid) => (0, import_jsx_runtime.jsxs)(ComponentLink, {
                  // used to stop the edit form from appearing when we click here.
                  onClick: (e) => e.stopPropagation(),
      ...
      value.name !== TEMP_FIELD_NAME && (0, import_jsx_runtime.jsx)(EditFieldForm, {
        attribute,
        name,
                ...
                (0, import_jsx_runtime.jsxs)(Grid.Root, {
                  children: [
                    ...
                    (0, import_jsx_runtime.jsx)(Grid.Item, {
                      ...
                      direction: "column",
                      alignItems: "stretch",
                      children: (0, import_jsx_runtime.jsx)(Fields, {
                        attributes,
                        components,
                        fieldSizes,
                        metadatas
...
//# sourceMappingURL=chunk-EEAGXCRP.js.map
