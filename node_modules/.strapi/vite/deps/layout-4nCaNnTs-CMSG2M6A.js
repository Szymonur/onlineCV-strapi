...
import {
  ...
  FlexWrapper,
  LinkEllipsis
} from "./chunk-PTSITJWZ.js";
import "./chunk-6BZHFLRY.js";
import {
  ItemTypes
...
// node_modules/@strapi/content-manager/dist/admin/chunks/layout-4nCaNnTs.mjs
...
var ComponentDragPreview = ({ displayedValue }) => {
  return (0, import_jsx_runtime.jsxs)(Flex, {
    ...
    width: "30rem",
    children: [
      (0, import_jsx_runtime.jsx)(ToggleButton, {
        type: "button",
        children: (0, import_jsx_runtime.jsxs)(Flex, {
          gap: 6,
          children: [
            (0, import_jsx_runtime.jsx)(DropdownIconWrapper, {
              alignItems: "center",
  ...
  return (0, import_jsx_runtime.jsx)(Box, {
    ...
    children: (0, import_jsx_runtime.jsxs)(Flex, {
      ...
      children: [
            ...
            (0, import_jsx_runtime.jsxs)(Flex, {
              ...
              children: [
                (0, import_jsx_runtime.jsx)(Box, {
                  ...
                  paddingBottom: 1,
                  paddingRight: 4,
                  children: (0, import_jsx_runtime.jsx)(LinkEllipsis, {
                    href: "",
                    children: (0, import_jsx_runtime.jsx)(Typography, {
        ...
        (0, import_jsx_runtime.jsx)(DisconnectButton, {
          type: "button",
    ...
    children: [
      ...
      (0, import_jsx_runtime.jsx)(SubNavSections, {
        children: menu.map((section) => {
          return (0, import_jsx_runtime.jsx)(SubNavSection, {
            label: section.title,
...
var Layout = () => {
  ...
  return (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, {
    children: [
      ...
      (0, import_jsx_runtime.jsxs)(Layouts.Root, {
        sideNav: (0, import_jsx_runtime.jsx)(LeftMenu, {}),
        children: [
          (0, import_jsx_runtime.jsx)(DragLayer, {
...
function renderDraglayerItem({ type, item }) {
  ...
  switch (actualType) {
    ...
    case ItemTypes.FIELD:
      return (0, import_jsx_runtime.jsx)(CardDragPreview, {
        label: item.label
      });
    case ItemTypes.COMPONENT:
    case ItemTypes.DYNAMIC_ZONE:
      return (0, import_jsx_runtime.jsx)(ComponentDragPreview, {
        displayedValue: item.displayedValue
      });
    case ItemTypes.RELATION:
      return (0, import_jsx_runtime.jsx)(RelationDragPreview, {
        ...item
      });
    default:
      return null;
...
//# sourceMappingURL=layout-4nCaNnTs-CMSG2M6A.js.map
