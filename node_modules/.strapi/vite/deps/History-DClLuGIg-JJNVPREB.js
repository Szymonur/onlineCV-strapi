import {
  ...
  useFieldHint,
  useLazyComponents
} from "./chunk-2XRVOTGK.js";
import "./chunk-PTSITJWZ.js";
import "./chunk-BINU3BVE.js";
import {
  getRelationLabel
} from "./chunk-6BZHFLRY.js";
import "./chunk-6NRKYAVJ.js";
import "./chunk-QXUPE6RX.js";
import "./chunk-SURG3JHW.js";
import {
  useTypedSelector
} from "./chunk-LLGF6CWR.js";
import "./chunk-G63TEG66.js";
import {
  COLLECTION_TYPES,
  DocumentRBAC,
  DocumentStatus,
...
// node_modules/@strapi/content-manager/dist/admin/chunks/History-DClLuGIg.mjs
...
import "/Users/szymon/Documents/online-cv/onlineCV-strapi/node_modules/prismjs/themes/prism-solarizedlight.css";
...
import "/Users/szymon/Documents/online-cv/onlineCV-strapi/node_modules/highlight.js/styles/solarized-dark.css";
...
var FormPanel = ({ panel }) => {
  if (panel.some((row) => row.some((field) => field.type === "dynamiczone"))) {
    ...
    return (0, import_jsx_runtime.jsx)(Grid.Root, {
      ...
      children: (0, import_jsx_runtime.jsx)(Grid.Item, {
        ...
        direction: "column",
        alignItems: "stretch",
        children: (0, import_jsx_runtime.jsx)(VersionInputRenderer, {
          ...field
        })
      })
    }, field.name);
  ...
  return (0, import_jsx_runtime.jsx)(Box, {
    ...
    children: (0, import_jsx_runtime.jsx)(Flex, {
      ...
      alignItems: "stretch",
      gap: 6,
      children: panel.map((row, gridRowIndex) => (0, import_jsx_runtime.jsx)(Grid.Root, {
        gap: 4,
...
var VersionContent = () => {
  ...
  return (0, import_jsx_runtime.jsxs)(Layouts.Content, {
    children: [
      (0, import_jsx_runtime.jsx)(Box, {
        paddingBottom: 8,
        children: (0, import_jsx_runtime.jsx)(Form, {
          ...
          children: (0, import_jsx_runtime.jsx)(Flex, {
            ...
            children: [
              ...
              return (0, import_jsx_runtime.jsx)(FormPanel, {
                panel
              }, index);
            })
          })
      ...
      removedAttributesAsFields.length > 0 && (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, {
        children: [
                ...
                children: [
                  ...
                  (0, import_jsx_runtime.jsx)(Typography, {
                    ...
                    children: formatMessage({
                      ...
                      b: (chunks) => (0, import_jsx_runtime.jsx)(Typography, {
                        variant: "pi",
                        fontWeight: "bold",
                        children: chunks
                      })
...
var VersionHeader = ({ headerId }) => {
  ...
  return (0, import_jsx_runtime.jsxs)(Dialog.Root, {
    ...
    children: [
      (0, import_jsx_runtime.jsx)(Layouts.BaseHeader, {
        id: headerId,
        ...
        subtitle: (0, import_jsx_runtime.jsx)(Typography, {
          variant: "epsilon",
        ...
        navigationAction: (0, import_jsx_runtime.jsx)(Link2, {
        ...
        sticky: false,
        primaryAction: (0, import_jsx_runtime.jsx)(Dialog.Trigger, {
...
var BlueText = (children) => (0, import_jsx_runtime.jsx)(Typography, {
...
var VersionCard = ({ version, isCurrent }) => {
  ...
  return (0, import_jsx_runtime.jsxs)(Flex, {
    ...
    children: [
        ...
        children: [
          ...
          (0, import_jsx_runtime.jsx)(Typography, {
            ...
            children: formatMessage({
              ...
              distanceToNow: (0, import_jsx_runtime.jsx)(RelativeTime, {
      ...
      version.status && (0, import_jsx_runtime.jsx)(DocumentStatus, {
  ...
  return (0, import_jsx_runtime.jsxs)(Flex, {
    ...
    children: [
      ...
      (0, import_jsx_runtime.jsxs)(Box, {
        ...
        overflow: "auto",
        children: [
          versions.meta.pagination.page > 1 && (0, import_jsx_runtime.jsx)(Box, {
            paddingTop: 4,
            textAlign: "center",
            children: (0, import_jsx_runtime.jsx)(PaginationButton, {
              page: page - 1,
              children: formatMessage({
          ...
          (0, import_jsx_runtime.jsx)(Flex, {
            ...
            tag: "ul",
            alignItems: "stretch",
            children: versions.data.map((version, index) => (0, import_jsx_runtime.jsx)("li", {
              "aria-label": formatMessage({
                id: "content-manager.history.sidebar.title.version-card.aria-label",
                defaultMessage: "Version card"
              }),
              children: (0, import_jsx_runtime.jsx)(VersionCard, {
                version,
                isCurrent: page === 1 && index === 0
              })
            }, version.id))
          }),
          versions.meta.pagination.page < versions.meta.pagination.pageCount && (0, import_jsx_runtime.jsx)(Box, {
            paddingBottom: 4,
            textAlign: "center",
            children: (0, import_jsx_runtime.jsx)(PaginationButton, {
              page: page + 1,
...
var HistoryPage = () => {
  ...
  if (!versionsResponse.isError && !((_b = (_a = versionsResponse.data) == null ? void 0 : _a.data) == null ? void 0 : _b.length)) {
    return (0, import_jsx_runtime.jsx)(import_jsx_runtime.Fragment, {
      children: (0, import_jsx_runtime.jsx)(Page.NoData, {
  ...
  return (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, {
    children: [
      ...
      (0, import_jsx_runtime.jsx)(HistoryProvider, {
        contentType: slug,
        id: documentId,
        schema,
        layout,
        ...
        children: (0, import_jsx_runtime.jsxs)(Flex, {
          ...
          alignItems: "flex-start",
          children: [
            (0, import_jsx_runtime.jsxs)(Main, {
              grow: 1,
              height: "100vh",
              ...
              labelledBy: headerId,
              children: [
                (0, import_jsx_runtime.jsx)(VersionHeader, {
                  headerId
                }),
  ...
  return (0, import_jsx_runtime.jsx)(Box, {
    ...
    children: (0, import_jsx_runtime.jsx)(Page.Protect, {
      ...
      children: ({ permissions: permissions2 }) => (0, import_jsx_runtime.jsx)(DocumentRBAC, {
        ...
        children: (0, import_jsx_runtime.jsx)(HistoryPage, {})
      })
    })
  });
};
var ProtectedHistoryPage = () => {
  return (0, import_jsx_runtime.jsx)(Portal$1, {
    children: (0, import_jsx_runtime.jsx)(FocusTrap, {
      children: (0, import_jsx_runtime.jsx)(ProtectedHistoryPageImpl, {})
    })
  });
};
export {
...
//# sourceMappingURL=History-DClLuGIg-JJNVPREB.js.map
