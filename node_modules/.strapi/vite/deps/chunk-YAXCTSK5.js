...
// node_modules/@strapi/content-releases/dist/admin/chunks/index-DEy-8PzZ.mjs
...
var RELEASE_ACTION_FORM_SCHEMA = create2().shape({
  type: create().oneOf([
    "publish",
    "unpublish"
  ]).required(),
  releaseId: create().required()
});
var INITIAL_VALUES = {
  type: "publish",
  releaseId: ""
...
var AddActionToReleaseModal = ({ contentType, documentId, onInputChange, values }) => {
  ...
  if ((releases == null ? void 0 : releases.length) === 0) {
    return (0, import_jsx_runtime.jsx)(NoReleases, {});
  }
  return (0, import_jsx_runtime.jsxs)(Flex, {
    direction: "column",
    alignItems: "stretch",
        ...
        children: (0, import_jsx_runtime.jsxs)(Field.Root, {
          ...
          children: [
            ...
            (0, import_jsx_runtime.jsx)(SingleSelect, {
              ...
              children: releases == null ? void 0 : releases.map((release) => (0, import_jsx_runtime.jsx)(SingleSelectOption, {
                value: release.id,
...
var ReleaseActionModalForm = ({ documentId, document, model, collectionType }) => {
  ...
  return {
    ...
    icon: (0, import_jsx_runtime.jsx)(ForwardRef$1B, {}),
    ...
    dialog: {
      ...
      content: (0, import_jsx_runtime.jsx)(AddActionToReleaseModal, {
        contentType: model,
        documentId,
        onInputChange: formik.setFieldValue,
        values: formik.values
      }),
      footer: ({ onClose }) => (0, import_jsx_runtime.jsxs)(Modal.Footer, {
        children: [
    ...
    dialog: {
      ...
      content: ({ onClose }) => {
        return (0, import_jsx_runtime.jsx)(Formik, {
          ...
          validationSchema: RELEASE_ACTION_FORM_SCHEMA,
          initialValues: INITIAL_VALUES,
          children: ({ values, setFieldValue }) => (0, import_jsx_runtime.jsxs)(Form, {
            children: [
              (releases == null ? void 0 : releases.length) === 0 ? (0, import_jsx_runtime.jsx)(NoReleases, {}) : (0, import_jsx_runtime.jsx)(Modal.Body, {
  ...
  return {
    displayedHeaders: [
      ...displayedHeaders,
      {
        ...
        cellFormatter: (props, _, { model }) => (0, import_jsx_runtime.jsx)(ReleaseListCell, {
          ...props,
          model
        })
      }
    ...
    children: [
      (0, import_jsx_runtime.jsx)(Popover.Trigger, {
        children: (0, import_jsx_runtime.jsx)(Button, {
          ...
          endIcon: releases.length > 0 ? (0, import_jsx_runtime.jsx)(ForwardRef$4T, {
            width: "1.2rem",
            height: "1.2rem"
          }) : null,
      ...
      (0, import_jsx_runtime.jsx)(Popover.Content, {
        children: (0, import_jsx_runtime.jsx)("ul", {
          children: releases.map(({ id, name }) => (0, import_jsx_runtime.jsx)(Box, {
            padding: 3,
            tag: "li",
...
var DeleteReleaseActionItem = ({ releaseId, actionId }) => {
  ...
  return (0, import_jsx_runtime.jsx)(StyledMenuItem, {
    $variant: "danger",
    onSelect: handleDeleteAction,
    children: (0, import_jsx_runtime.jsxs)(Flex, {
      gap: 2,
      children: [
        (0, import_jsx_runtime.jsx)(ForwardRef$45, {
          width: "1.6rem",
          height: "1.6rem"
        }),
...
var Root = ({ children }) => {
  ...
  return (
    ...
    allowedActions.canDeleteAction || allowedActions.canUpdate ? (0, import_jsx_runtime.jsxs)(Menu.Root, {
      children: [
        (0, import_jsx_runtime.jsx)(StyledMoreButton, {
          variant: "tertiary",
          endIcon: null,
          paddingLeft: "7px",
          paddingRight: "7px",
          children: (0, import_jsx_runtime.jsx)(AccessibleIcon, {
            label: formatMessage({
...
var Panel = ({ model, document, documentId, collectionType }) => {
  ...
  return {
    ...
    content: (0, import_jsx_runtime.jsx)(Flex, {
      direction: "column",
      alignItems: "stretch",
      gap: 3,
      width: "100%",
      children: releases == null ? void 0 : releases.map((release) => (0, import_jsx_runtime.jsxs)(Flex, {
        direction: "column",
        alignItems: "start",
        borderWidth: "1px",
        borderStyle: "solid",
        ...
        children: [
          ...
          (0, import_jsx_runtime.jsxs)(Flex, {
            ...
            children: [
              ...
              release.scheduledAt && release.timezone && (0, import_jsx_runtime.jsx)(Typography, {
                variant: "pi",
              ...
              canDeleteAction ? (0, import_jsx_runtime.jsxs)(ReleaseActionMenu.Root, {
                hasTriggerBorder: true,
                children: [
                  (0, import_jsx_runtime.jsx)(ReleaseActionMenu.EditReleaseItem, {
...
function __variableDynamicImportRuntime3__(path) {
  switch (path) {
    case "./translations/en.json":
      return import("./en-aQo8Bn_U-XFQEXOKY.js");
    case "./translations/uk.json":
      return import("./uk-Bp9HotPq-KUMUYNSO.js");
    default:
  ...
  register(app) {
    ...
    if (window.strapi.features.isEnabled("cms-content-releases")) {
      app.addMenuLink({
        ...
        Component: () => import("./App-BEyv0kMo-IEAZUAWO.js").then((mod) => ({
          default: mod.App
        })),
      ...
      app.addSettingsLink("global", {
        ...
        permissions: [],
        async Component() {
          const { ProtectedReleasesSettingsPage } = await import("./ReleasesSettingsPage-lky_0-wG-QJD7WB75.js");
          return {
      ...
      app.addSettingsLink("global", {
        ...
        permissions: [],
        async Component() {
          const { PurchaseContentReleases } = await import("./PurchaseContentReleases-U5sGMPgR-RXA633GQ.js");
          return {
...
//# sourceMappingURL=chunk-YAXCTSK5.js.map
